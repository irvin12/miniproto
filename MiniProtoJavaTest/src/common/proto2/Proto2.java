...
public class Proto2 {
		...
		public int ByteSize() throws IOException {
			...
			if (has_m_sint32()) {
				if (null != m_sint32_) {
					...
					bytes += common.miniproto.ProtoTool.ArrayByteSize(m_sint32_, common.miniproto.ProtoDefine.ProtoFieldType.PFT_SInt32);
				}
			}
			if (has_m_uint32()) {
				if (null != m_uint32_) {
					bytes += common.miniproto.ProtoTool.KeyByteSize(4, common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited);
					bytes += common.miniproto.ProtoTool.ArrayByteSize(m_uint32_, common.miniproto.ProtoDefine.ProtoFieldType.PFT_UInt32);
				}
			}
			if (has_m_int64()) {
				if (null != m_int64_) {
			...
			if (has_m_sint64()) {
				if (null != m_sint64_) {
					...
					bytes += common.miniproto.ProtoTool.ArrayByteSize(m_sint64_, common.miniproto.ProtoDefine.ProtoFieldType.PFT_SInt64);
				}
			}
			if (has_m_uint64()) {
				if (null != m_uint64_) {
					bytes += common.miniproto.ProtoTool.KeyByteSize(7, common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited);
					bytes += common.miniproto.ProtoTool.ArrayByteSize(m_uint64_, common.miniproto.ProtoDefine.ProtoFieldType.PFT_UInt64);
				}
			}
			if (has_m_float()) {
				if (null != m_float_) {
		...
		public void Code(OutputStream buf, int size) throws IOException {
			...
			if (has_m_sint32()) {
				if (null != m_sint32_) {
					...
					common.miniproto.ProtoTool.ArrayCode(m_sint32_, buf, common.miniproto.ProtoDefine.ProtoFieldType.PFT_SInt32);
				}
			}
			if (has_m_uint32()) {
				if (null != m_uint32_) {
					common.miniproto.ProtoTool.KeyCode(4, common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited, buf);
					common.miniproto.ProtoTool.ArrayCode(m_uint32_, buf, common.miniproto.ProtoDefine.ProtoFieldType.PFT_UInt32);
				}
			}
			if (has_m_int64()) {
				if (null != m_int64_) {
			...
			if (has_m_sint64()) {
				if (null != m_sint64_) {
					...
					common.miniproto.ProtoTool.ArrayCode(m_sint64_, buf, common.miniproto.ProtoDefine.ProtoFieldType.PFT_SInt64);
				}
			}
			if (has_m_uint64()) {
				if (null != m_uint64_) {
					common.miniproto.ProtoTool.KeyCode(7, common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited, buf);
					common.miniproto.ProtoTool.ArrayCode(m_uint64_, buf, common.miniproto.ProtoDefine.ProtoFieldType.PFT_UInt64);
				}
			}
			if (has_m_float()) {
				if (null != m_float_) {
			...
			while ((oldPos - buf.available()) < size) {
				...
				switch (key) {
					...
					case 3 << 3 | common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited_VALUE : {
						...
						if (null != m_sint32_) {
							common.miniproto.ProtoTool.ArrayDecode(m_sint32_, buf, common.miniproto.ProtoDefine.ProtoFieldType.PFT_SInt32);
							set_has_m_sint32();
						} else {
							common.miniproto.ProtoTool.UnknownDecode(type, buf);
						}
					...
					case 4 << 3 | common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited_VALUE : {
						...
						if (null != m_uint32_) {
							common.miniproto.ProtoTool.ArrayDecode(m_uint32_, buf, common.miniproto.ProtoDefine.ProtoFieldType.PFT_UInt32);
							set_has_m_uint32();
						} else {
							common.miniproto.ProtoTool.UnknownDecode(type, buf);
						}
					...
					case 6 << 3 | common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited_VALUE : {
						...
						if (null != m_sint64_) {
							common.miniproto.ProtoTool.ArrayDecode(m_sint64_, buf, common.miniproto.ProtoDefine.ProtoFieldType.PFT_SInt64);
							set_has_m_sint64();
						} else {
							common.miniproto.ProtoTool.UnknownDecode(type, buf);
						}
					...
					case 7 << 3 | common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited_VALUE : {
						...
						if (null != m_uint64_) {
							common.miniproto.ProtoTool.ArrayDecode(m_uint64_, buf, common.miniproto.ProtoDefine.ProtoFieldType.PFT_UInt64);
							set_has_m_uint64();
						} else {
							common.miniproto.ProtoTool.UnknownDecode(type, buf);
						}
	...
	public static class MsgTestSet extends common.miniproto.ProtoBase {
		...
		private java.util.TreeSet<Integer> m_sint32_;
		...
		public void set_m_sint32(java.util.TreeSet<Integer> value) {
			if (null != value) {
				m_sint32_ = value;
				set_has_m_sint32();
			}
		...
		public void add_m_sint32(Integer value) {
			if (null == m_sint32_) {
				m_sint32_ = new java.util.TreeSet<Integer>();
			}
			if (null != m_sint32_ && null != value) {
				m_sint32_.add(value);
				set_has_m_sint32();
		...
		public void add_m_sint64(Long value) {
			if (null == m_sint64_) {
				m_sint64_ = new java.util.TreeSet<Long>();
			}
			if (null != m_sint64_ && null != value) {
				m_sint64_.add(value);
				set_has_m_sint64();
		...
		private java.util.TreeSet<String> m_string_;
		...
		public void set_m_string(java.util.TreeSet<String> value) {
			if (null != value) {
				m_string_ = value;
				set_has_m_string();
			}
		...
		public void add_m_string(String value) {
			if (null == m_string_) {
				m_string_ = new java.util.TreeSet<String>();
			}
			if (null != m_string_ && null != value) {
				m_string_.add(value);
				set_has_m_string();
		...
		public int ByteSize() throws IOException {
			...
			if (has_m_sint32()) {
				if (null != m_sint32_) {
					bytes += common.miniproto.ProtoTool.KeyByteSize(2, common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited);
					bytes += common.miniproto.ProtoTool.SetByteSize(m_sint32_, common.miniproto.ProtoDefine.ProtoFieldType.PFT_SInt32);
				}
			}
			if (has_m_uint32()) {
				if (null != m_uint32_) {
					bytes += common.miniproto.ProtoTool.KeyByteSize(3, common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited);
					bytes += common.miniproto.ProtoTool.SetByteSize(m_uint32_, common.miniproto.ProtoDefine.ProtoFieldType.PFT_UInt32);
				}
			}
			if (has_m_int64()) {
				if (null != m_int64_) {
			...
			if (has_m_sint64()) {
				if (null != m_sint64_) {
					bytes += common.miniproto.ProtoTool.KeyByteSize(5, common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited);
					bytes += common.miniproto.ProtoTool.SetByteSize(m_sint64_, common.miniproto.ProtoDefine.ProtoFieldType.PFT_SInt64);
				}
			}
			if (has_m_uint64()) {
				if (null != m_uint64_) {
					bytes += common.miniproto.ProtoTool.KeyByteSize(6, common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited);
					bytes += common.miniproto.ProtoTool.SetByteSize(m_uint64_, common.miniproto.ProtoDefine.ProtoFieldType.PFT_UInt64);
				}
			}
			if (has_m_string()) {
				if (null != m_string_) {
		...
		public void Code(OutputStream buf, int size) throws IOException {
			...
			if (has_m_sint32()) {
				if (null != m_sint32_) {
					common.miniproto.ProtoTool.KeyCode(2, common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited, buf);
					common.miniproto.ProtoTool.SetCode(m_sint32_, buf, common.miniproto.ProtoDefine.ProtoFieldType.PFT_SInt32);
				}
			}
			if (has_m_uint32()) {
				if (null != m_uint32_) {
					common.miniproto.ProtoTool.KeyCode(3, common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited, buf);
					common.miniproto.ProtoTool.SetCode(m_uint32_, buf, common.miniproto.ProtoDefine.ProtoFieldType.PFT_UInt32);
				}
			}
			if (has_m_int64()) {
				if (null != m_int64_) {
			...
			if (has_m_sint64()) {
				if (null != m_sint64_) {
					common.miniproto.ProtoTool.KeyCode(5, common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited, buf);
					common.miniproto.ProtoTool.SetCode(m_sint64_, buf, common.miniproto.ProtoDefine.ProtoFieldType.PFT_SInt64);
				}
			}
			if (has_m_uint64()) {
				if (null != m_uint64_) {
					common.miniproto.ProtoTool.KeyCode(6, common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited, buf);
					common.miniproto.ProtoTool.SetCode(m_uint64_, buf, common.miniproto.ProtoDefine.ProtoFieldType.PFT_UInt64);
				}
			}
			if (has_m_string()) {
				if (null != m_string_) {
			...
			while ((oldPos - buf.available()) < size) {
				...
				switch (key) {
					...
					case 2 << 3 | common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited_VALUE : {
						...
						if (null != m_sint32_) {
							common.miniproto.ProtoTool.SetDecode(m_sint32_, buf, common.miniproto.ProtoDefine.ProtoFieldType.PFT_SInt32);
							set_has_m_sint32();
						} else {
							common.miniproto.ProtoTool.UnknownDecode(type, buf);
						}
					...
					case 3 << 3 | common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited_VALUE : {
						...
						if (null != m_uint32_) {
							common.miniproto.ProtoTool.SetDecode(m_uint32_, buf, common.miniproto.ProtoDefine.ProtoFieldType.PFT_UInt32);
							set_has_m_uint32();
						} else {
							common.miniproto.ProtoTool.UnknownDecode(type, buf);
						}
					...
					case 5 << 3 | common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited_VALUE : {
						...
						if (null != m_sint64_) {
							common.miniproto.ProtoTool.SetDecode(m_sint64_, buf, common.miniproto.ProtoDefine.ProtoFieldType.PFT_SInt64);
							set_has_m_sint64();
						} else {
							common.miniproto.ProtoTool.UnknownDecode(type, buf);
						}
					...
					case 6 << 3 | common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited_VALUE : {
						...
						if (null != m_uint64_) {
							common.miniproto.ProtoTool.SetDecode(m_uint64_, buf, common.miniproto.ProtoDefine.ProtoFieldType.PFT_UInt64);
							set_has_m_uint64();
						} else {
							common.miniproto.ProtoTool.UnknownDecode(type, buf);
						}
	...
	public static class MsgTestMap extends common.miniproto.ProtoBase {
		...
		public int ByteSize() throws IOException {
			...
			if (has_m_sint32bool()) {
				if (null != m_sint32bool_) {
					bytes += common.miniproto.ProtoTool.KeyByteSize(2, common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited);
					bytes += common.miniproto.ProtoTool.MapByteSize(m_sint32bool_, common.miniproto.ProtoDefine.ProtoFieldType.PFT_SInt32, common.miniproto.ProtoDefine.ProtoFieldType.PFT_Bool);
				}
			}
			if (has_m_uint32bool()) {
				if (null != m_uint32bool_) {
					bytes += common.miniproto.ProtoTool.KeyByteSize(3, common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited);
					bytes += common.miniproto.ProtoTool.MapByteSize(m_uint32bool_, common.miniproto.ProtoDefine.ProtoFieldType.PFT_UInt32, common.miniproto.ProtoDefine.ProtoFieldType.PFT_Bool);
				}
			}
			if (has_m_int64bool()) {
				if (null != m_int64bool_) {
			...
			if (has_m_sint64bool()) {
				if (null != m_sint64bool_) {
					bytes += common.miniproto.ProtoTool.KeyByteSize(5, common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited);
					bytes += common.miniproto.ProtoTool.MapByteSize(m_sint64bool_, common.miniproto.ProtoDefine.ProtoFieldType.PFT_SInt64, common.miniproto.ProtoDefine.ProtoFieldType.PFT_Bool);
				}
			}
			if (has_m_uint64bool()) {
				if (null != m_uint64bool_) {
					bytes += common.miniproto.ProtoTool.KeyByteSize(6, common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited);
					bytes += common.miniproto.ProtoTool.MapByteSize(m_uint64bool_, common.miniproto.ProtoDefine.ProtoFieldType.PFT_UInt64, common.miniproto.ProtoDefine.ProtoFieldType.PFT_Bool);
				}
			}
			if (has_m_stringbool()) {
				if (null != m_stringbool_) {
			...
			if (has_m_sint32int32()) {
				if (null != m_sint32int32_) {
					bytes += common.miniproto.ProtoTool.KeyByteSize(9, common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited);
					bytes += common.miniproto.ProtoTool.MapByteSize(m_sint32int32_, common.miniproto.ProtoDefine.ProtoFieldType.PFT_SInt32, common.miniproto.ProtoDefine.ProtoFieldType.PFT_Int32);
				}
			}
			if (has_m_uint32int32()) {
				if (null != m_uint32int32_) {
					bytes += common.miniproto.ProtoTool.KeyByteSize(10, common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited);
					bytes += common.miniproto.ProtoTool.MapByteSize(m_uint32int32_, common.miniproto.ProtoDefine.ProtoFieldType.PFT_UInt32, common.miniproto.ProtoDefine.ProtoFieldType.PFT_Int32);
				}
			}
			if (has_m_int64int32()) {
				if (null != m_int64int32_) {
			...
			if (has_m_sint64int32()) {
				if (null != m_sint64int32_) {
					...
					bytes += common.miniproto.ProtoTool.MapByteSize(m_sint64int32_, common.miniproto.ProtoDefine.ProtoFieldType.PFT_SInt64, common.miniproto.ProtoDefine.ProtoFieldType.PFT_Int32);
				}
			}
			if (has_m_uint64int32()) {
				if (null != m_uint64int32_) {
					bytes += common.miniproto.ProtoTool.KeyByteSize(13, common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited);
					bytes += common.miniproto.ProtoTool.MapByteSize(m_uint64int32_, common.miniproto.ProtoDefine.ProtoFieldType.PFT_UInt64, common.miniproto.ProtoDefine.ProtoFieldType.PFT_Int32);
				}
			}
			if (has_m_stringint32()) {
				if (null != m_stringint32_) {
			...
			if (has_m_int32sint32()) {
				if (null != m_int32sint32_) {
					...
					bytes += common.miniproto.ProtoTool.MapByteSize(m_int32sint32_, common.miniproto.ProtoDefine.ProtoFieldType.PFT_Int32, common.miniproto.ProtoDefine.ProtoFieldType.PFT_SInt32);
				}
			}
			if (has_m_sint32sint32()) {
				if (null != m_sint32sint32_) {
					bytes += common.miniproto.ProtoTool.KeyByteSize(16, common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited);
					bytes += common.miniproto.ProtoTool.MapByteSize(m_sint32sint32_, common.miniproto.ProtoDefine.ProtoFieldType.PFT_SInt32, common.miniproto.ProtoDefine.ProtoFieldType.PFT_SInt32);
				}
			}
			if (has_m_uint32sint32()) {
				if (null != m_uint32sint32_) {
					bytes += common.miniproto.ProtoTool.KeyByteSize(17, common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited);
					bytes += common.miniproto.ProtoTool.MapByteSize(m_uint32sint32_, common.miniproto.ProtoDefine.ProtoFieldType.PFT_UInt32, common.miniproto.ProtoDefine.ProtoFieldType.PFT_SInt32);
				}
			}
			if (has_m_int64sint32()) {
				if (null != m_int64sint32_) {
					bytes += common.miniproto.ProtoTool.KeyByteSize(18, common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited);
					bytes += common.miniproto.ProtoTool.MapByteSize(m_int64sint32_, common.miniproto.ProtoDefine.ProtoFieldType.PFT_Int64, common.miniproto.ProtoDefine.ProtoFieldType.PFT_SInt32);
				}
			}
			if (has_m_sint64sint32()) {
				if (null != m_sint64sint32_) {
					bytes += common.miniproto.ProtoTool.KeyByteSize(19, common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited);
					bytes += common.miniproto.ProtoTool.MapByteSize(m_sint64sint32_, common.miniproto.ProtoDefine.ProtoFieldType.PFT_SInt64, common.miniproto.ProtoDefine.ProtoFieldType.PFT_SInt32);
				}
			}
			if (has_m_uint64sint32()) {
				if (null != m_uint64sint32_) {
					bytes += common.miniproto.ProtoTool.KeyByteSize(20, common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited);
					bytes += common.miniproto.ProtoTool.MapByteSize(m_uint64sint32_, common.miniproto.ProtoDefine.ProtoFieldType.PFT_UInt64, common.miniproto.ProtoDefine.ProtoFieldType.PFT_SInt32);
				}
			}
			if (has_m_stringsint32()) {
				if (null != m_stringsint32_) {
					bytes += common.miniproto.ProtoTool.KeyByteSize(21, common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited);
					bytes += common.miniproto.ProtoTool.MapByteSize(m_stringsint32_, common.miniproto.ProtoDefine.ProtoFieldType.PFT_String, common.miniproto.ProtoDefine.ProtoFieldType.PFT_SInt32);
				}
			}
			if (has_m_int32uint32()) {
				if (null != m_int32uint32_) {
					bytes += common.miniproto.ProtoTool.KeyByteSize(22, common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited);
					bytes += common.miniproto.ProtoTool.MapByteSize(m_int32uint32_, common.miniproto.ProtoDefine.ProtoFieldType.PFT_Int32, common.miniproto.ProtoDefine.ProtoFieldType.PFT_UInt32);
				}
			}
			if (has_m_sint32uint32()) {
				if (null != m_sint32uint32_) {
					bytes += common.miniproto.ProtoTool.KeyByteSize(23, common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited);
					bytes += common.miniproto.ProtoTool.MapByteSize(m_sint32uint32_, common.miniproto.ProtoDefine.ProtoFieldType.PFT_SInt32, common.miniproto.ProtoDefine.ProtoFieldType.PFT_UInt32);
				}
			}
			if (has_m_uint32uint32()) {
				if (null != m_uint32uint32_) {
					bytes += common.miniproto.ProtoTool.KeyByteSize(24, common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited);
					bytes += common.miniproto.ProtoTool.MapByteSize(m_uint32uint32_, common.miniproto.ProtoDefine.ProtoFieldType.PFT_UInt32, common.miniproto.ProtoDefine.ProtoFieldType.PFT_UInt32);
				}
			}
			if (has_m_int64uint32()) {
				if (null != m_int64uint32_) {
					bytes += common.miniproto.ProtoTool.KeyByteSize(25, common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited);
					bytes += common.miniproto.ProtoTool.MapByteSize(m_int64uint32_, common.miniproto.ProtoDefine.ProtoFieldType.PFT_Int64, common.miniproto.ProtoDefine.ProtoFieldType.PFT_UInt32);
				}
			}
			if (has_m_sint64uint32()) {
				if (null != m_sint64uint32_) {
					bytes += common.miniproto.ProtoTool.KeyByteSize(26, common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited);
					bytes += common.miniproto.ProtoTool.MapByteSize(m_sint64uint32_, common.miniproto.ProtoDefine.ProtoFieldType.PFT_SInt64, common.miniproto.ProtoDefine.ProtoFieldType.PFT_UInt32);
				}
			}
			if (has_m_uint64uint32()) {
				if (null != m_uint64uint32_) {
					bytes += common.miniproto.ProtoTool.KeyByteSize(27, common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited);
					bytes += common.miniproto.ProtoTool.MapByteSize(m_uint64uint32_, common.miniproto.ProtoDefine.ProtoFieldType.PFT_UInt64, common.miniproto.ProtoDefine.ProtoFieldType.PFT_UInt32);
				}
			}
			if (has_m_stringuint32()) {
				if (null != m_stringuint32_) {
					bytes += common.miniproto.ProtoTool.KeyByteSize(28, common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited);
					bytes += common.miniproto.ProtoTool.MapByteSize(m_stringuint32_, common.miniproto.ProtoDefine.ProtoFieldType.PFT_String, common.miniproto.ProtoDefine.ProtoFieldType.PFT_UInt32);
				}
			}
			if (has_m_int32int64()) {
				if (null != m_int32int64_) {
			...
			if (has_m_sint32int64()) {
				if (null != m_sint32int64_) {
					...
					bytes += common.miniproto.ProtoTool.MapByteSize(m_sint32int64_, common.miniproto.ProtoDefine.ProtoFieldType.PFT_SInt32, common.miniproto.ProtoDefine.ProtoFieldType.PFT_Int64);
				}
			}
			if (has_m_uint32int64()) {
				if (null != m_uint32int64_) {
					bytes += common.miniproto.ProtoTool.KeyByteSize(31, common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited);
					bytes += common.miniproto.ProtoTool.MapByteSize(m_uint32int64_, common.miniproto.ProtoDefine.ProtoFieldType.PFT_UInt32, common.miniproto.ProtoDefine.ProtoFieldType.PFT_Int64);
				}
			}
			if (has_m_int64int64()) {
				if (null != m_int64int64_) {
			...
			if (has_m_sint64int64()) {
				if (null != m_sint64int64_) {
					...
					bytes += common.miniproto.ProtoTool.MapByteSize(m_sint64int64_, common.miniproto.ProtoDefine.ProtoFieldType.PFT_SInt64, common.miniproto.ProtoDefine.ProtoFieldType.PFT_Int64);
				}
			}
			if (has_m_uint64int64()) {
				if (null != m_uint64int64_) {
					bytes += common.miniproto.ProtoTool.KeyByteSize(34, common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited);
					bytes += common.miniproto.ProtoTool.MapByteSize(m_uint64int64_, common.miniproto.ProtoDefine.ProtoFieldType.PFT_UInt64, common.miniproto.ProtoDefine.ProtoFieldType.PFT_Int64);
				}
			}
			if (has_m_stringint64()) {
				if (null != m_stringint64_) {
			...
			if (has_m_int32sint64()) {
				if (null != m_int32sint64_) {
					...
					bytes += common.miniproto.ProtoTool.MapByteSize(m_int32sint64_, common.miniproto.ProtoDefine.ProtoFieldType.PFT_Int32, common.miniproto.ProtoDefine.ProtoFieldType.PFT_SInt64);
				}
			}
			if (has_m_sint32sint64()) {
				if (null != m_sint32sint64_) {
					bytes += common.miniproto.ProtoTool.KeyByteSize(37, common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited);
					bytes += common.miniproto.ProtoTool.MapByteSize(m_sint32sint64_, common.miniproto.ProtoDefine.ProtoFieldType.PFT_SInt32, common.miniproto.ProtoDefine.ProtoFieldType.PFT_SInt64);
				}
			}
			if (has_m_uint32sint64()) {
				if (null != m_uint32sint64_) {
					bytes += common.miniproto.ProtoTool.KeyByteSize(38, common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited);
					bytes += common.miniproto.ProtoTool.MapByteSize(m_uint32sint64_, common.miniproto.ProtoDefine.ProtoFieldType.PFT_UInt32, common.miniproto.ProtoDefine.ProtoFieldType.PFT_SInt64);
				}
			}
			if (has_m_int64sint64()) {
				if (null != m_int64sint64_) {
					bytes += common.miniproto.ProtoTool.KeyByteSize(39, common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited);
					bytes += common.miniproto.ProtoTool.MapByteSize(m_int64sint64_, common.miniproto.ProtoDefine.ProtoFieldType.PFT_Int64, common.miniproto.ProtoDefine.ProtoFieldType.PFT_SInt64);
				}
			}
			if (has_m_sint64sint64()) {
				if (null != m_sint64sint64_) {
					bytes += common.miniproto.ProtoTool.KeyByteSize(40, common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited);
					bytes += common.miniproto.ProtoTool.MapByteSize(m_sint64sint64_, common.miniproto.ProtoDefine.ProtoFieldType.PFT_SInt64, common.miniproto.ProtoDefine.ProtoFieldType.PFT_SInt64);
				}
			}
			if (has_m_uint64sint64()) {
				if (null != m_uint64sint64_) {
					bytes += common.miniproto.ProtoTool.KeyByteSize(41, common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited);
					bytes += common.miniproto.ProtoTool.MapByteSize(m_uint64sint64_, common.miniproto.ProtoDefine.ProtoFieldType.PFT_UInt64, common.miniproto.ProtoDefine.ProtoFieldType.PFT_SInt64);
				}
			}
			if (has_m_stringsint64()) {
				if (null != m_stringsint64_) {
					bytes += common.miniproto.ProtoTool.KeyByteSize(42, common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited);
					bytes += common.miniproto.ProtoTool.MapByteSize(m_stringsint64_, common.miniproto.ProtoDefine.ProtoFieldType.PFT_String, common.miniproto.ProtoDefine.ProtoFieldType.PFT_SInt64);
				}
			}
			if (has_m_int32uint64()) {
				if (null != m_int32uint64_) {
					bytes += common.miniproto.ProtoTool.KeyByteSize(43, common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited);
					bytes += common.miniproto.ProtoTool.MapByteSize(m_int32uint64_, common.miniproto.ProtoDefine.ProtoFieldType.PFT_Int32, common.miniproto.ProtoDefine.ProtoFieldType.PFT_UInt64);
				}
			}
			if (has_m_sint32uint64()) {
				if (null != m_sint32uint64_) {
					bytes += common.miniproto.ProtoTool.KeyByteSize(44, common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited);
					bytes += common.miniproto.ProtoTool.MapByteSize(m_sint32uint64_, common.miniproto.ProtoDefine.ProtoFieldType.PFT_SInt32, common.miniproto.ProtoDefine.ProtoFieldType.PFT_UInt64);
				}
			}
			if (has_m_uint32uint64()) {
				if (null != m_uint32uint64_) {
					bytes += common.miniproto.ProtoTool.KeyByteSize(45, common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited);
					bytes += common.miniproto.ProtoTool.MapByteSize(m_uint32uint64_, common.miniproto.ProtoDefine.ProtoFieldType.PFT_UInt32, common.miniproto.ProtoDefine.ProtoFieldType.PFT_UInt64);
				}
			}
			if (has_m_int64uint64()) {
				if (null != m_int64uint64_) {
					bytes += common.miniproto.ProtoTool.KeyByteSize(46, common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited);
					bytes += common.miniproto.ProtoTool.MapByteSize(m_int64uint64_, common.miniproto.ProtoDefine.ProtoFieldType.PFT_Int64, common.miniproto.ProtoDefine.ProtoFieldType.PFT_UInt64);
				}
			}
			if (has_m_sint64uint64()) {
				if (null != m_sint64uint64_) {
					bytes += common.miniproto.ProtoTool.KeyByteSize(47, common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited);
					bytes += common.miniproto.ProtoTool.MapByteSize(m_sint64uint64_, common.miniproto.ProtoDefine.ProtoFieldType.PFT_SInt64, common.miniproto.ProtoDefine.ProtoFieldType.PFT_UInt64);
				}
			}
			if (has_m_uint64uint64()) {
				if (null != m_uint64uint64_) {
					bytes += common.miniproto.ProtoTool.KeyByteSize(48, common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited);
					bytes += common.miniproto.ProtoTool.MapByteSize(m_uint64uint64_, common.miniproto.ProtoDefine.ProtoFieldType.PFT_UInt64, common.miniproto.ProtoDefine.ProtoFieldType.PFT_UInt64);
				}
			}
			if (has_m_stringuint64()) {
				if (null != m_stringuint64_) {
					bytes += common.miniproto.ProtoTool.KeyByteSize(49, common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited);
					bytes += common.miniproto.ProtoTool.MapByteSize(m_stringuint64_, common.miniproto.ProtoDefine.ProtoFieldType.PFT_String, common.miniproto.ProtoDefine.ProtoFieldType.PFT_UInt64);
				}
			}
			if (has_m_int32float()) {
				if (null != m_int32float_) {
			...
			if (has_m_sint32float()) {
				if (null != m_sint32float_) {
					...
					bytes += common.miniproto.ProtoTool.MapByteSize(m_sint32float_, common.miniproto.ProtoDefine.ProtoFieldType.PFT_SInt32, common.miniproto.ProtoDefine.ProtoFieldType.PFT_Float);
				}
			}
			if (has_m_uint32float()) {
				if (null != m_uint32float_) {
					bytes += common.miniproto.ProtoTool.KeyByteSize(52, common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited);
					bytes += common.miniproto.ProtoTool.MapByteSize(m_uint32float_, common.miniproto.ProtoDefine.ProtoFieldType.PFT_UInt32, common.miniproto.ProtoDefine.ProtoFieldType.PFT_Float);
				}
			}
			if (has_m_int64float()) {
				if (null != m_int64float_) {
			...
			if (has_m_sint64float()) {
				if (null != m_sint64float_) {
					...
					bytes += common.miniproto.ProtoTool.MapByteSize(m_sint64float_, common.miniproto.ProtoDefine.ProtoFieldType.PFT_SInt64, common.miniproto.ProtoDefine.ProtoFieldType.PFT_Float);
				}
			}
			if (has_m_uint64float()) {
				if (null != m_uint64float_) {
					bytes += common.miniproto.ProtoTool.KeyByteSize(55, common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited);
					bytes += common.miniproto.ProtoTool.MapByteSize(m_uint64float_, common.miniproto.ProtoDefine.ProtoFieldType.PFT_UInt64, common.miniproto.ProtoDefine.ProtoFieldType.PFT_Float);
				}
			}
			if (has_m_stringfloat()) {
				if (null != m_stringfloat_) {
			...
			if (has_m_sint32double()) {
				if (null != m_sint32double_) {
					...
					bytes += common.miniproto.ProtoTool.MapByteSize(m_sint32double_, common.miniproto.ProtoDefine.ProtoFieldType.PFT_SInt32, common.miniproto.ProtoDefine.ProtoFieldType.PFT_Double);
				}
			}
			if (has_m_uint32double()) {
				if (null != m_uint32double_) {
					bytes += common.miniproto.ProtoTool.KeyByteSize(59, common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited);
					bytes += common.miniproto.ProtoTool.MapByteSize(m_uint32double_, common.miniproto.ProtoDefine.ProtoFieldType.PFT_UInt32, common.miniproto.ProtoDefine.ProtoFieldType.PFT_Double);
				}
			}
			if (has_m_int64double()) {
				if (null != m_int64double_) {
			...
			if (has_m_sint64double()) {
				if (null != m_sint64double_) {
					...
					bytes += common.miniproto.ProtoTool.MapByteSize(m_sint64double_, common.miniproto.ProtoDefine.ProtoFieldType.PFT_SInt64, common.miniproto.ProtoDefine.ProtoFieldType.PFT_Double);
				}
			}
			if (has_m_uint64double()) {
				if (null != m_uint64double_) {
					bytes += common.miniproto.ProtoTool.KeyByteSize(62, common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited);
					bytes += common.miniproto.ProtoTool.MapByteSize(m_uint64double_, common.miniproto.ProtoDefine.ProtoFieldType.PFT_UInt64, common.miniproto.ProtoDefine.ProtoFieldType.PFT_Double);
				}
			}
			if (has_m_stringdouble()) {
				if (null != m_stringdouble_) {
			...
			if (has_m_sint32enum()) {
				if (null != m_sint32enum_) {
					...
					bytes += common.miniproto.ProtoTool.MapByteSize(m_sint32enum_, common.miniproto.ProtoDefine.ProtoFieldType.PFT_SInt32, common.miniproto.ProtoDefine.ProtoFieldType.PFT_Enum);
				}
			}
			if (has_m_uint32enum()) {
				if (null != m_uint32enum_) {
					bytes += common.miniproto.ProtoTool.KeyByteSize(66, common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited);
					bytes += common.miniproto.ProtoTool.MapByteSize(m_uint32enum_, common.miniproto.ProtoDefine.ProtoFieldType.PFT_UInt32, common.miniproto.ProtoDefine.ProtoFieldType.PFT_Enum);
				}
			}
			if (has_m_int64enum()) {
				if (null != m_int64enum_) {
			...
			if (has_m_sint64enum()) {
				if (null != m_sint64enum_) {
					...
					bytes += common.miniproto.ProtoTool.MapByteSize(m_sint64enum_, common.miniproto.ProtoDefine.ProtoFieldType.PFT_SInt64, common.miniproto.ProtoDefine.ProtoFieldType.PFT_Enum);
				}
			}
			if (has_m_uint64enum()) {
				if (null != m_uint64enum_) {
					bytes += common.miniproto.ProtoTool.KeyByteSize(69, common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited);
					bytes += common.miniproto.ProtoTool.MapByteSize(m_uint64enum_, common.miniproto.ProtoDefine.ProtoFieldType.PFT_UInt64, common.miniproto.ProtoDefine.ProtoFieldType.PFT_Enum);
				}
			}
			if (has_m_stringenum()) {
				if (null != m_stringenum_) {
			...
			if (has_m_sint32string()) {
				if (null != m_sint32string_) {
					...
					bytes += common.miniproto.ProtoTool.MapByteSize(m_sint32string_, common.miniproto.ProtoDefine.ProtoFieldType.PFT_SInt32, common.miniproto.ProtoDefine.ProtoFieldType.PFT_String);
				}
			}
			if (has_m_uint32string()) {
				if (null != m_uint32string_) {
					bytes += common.miniproto.ProtoTool.KeyByteSize(73, common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited);
					bytes += common.miniproto.ProtoTool.MapByteSize(m_uint32string_, common.miniproto.ProtoDefine.ProtoFieldType.PFT_UInt32, common.miniproto.ProtoDefine.ProtoFieldType.PFT_String);
				}
			}
			if (has_m_int64string()) {
				if (null != m_int64string_) {
			...
			if (has_m_sint64string()) {
				if (null != m_sint64string_) {
					...
					bytes += common.miniproto.ProtoTool.MapByteSize(m_sint64string_, common.miniproto.ProtoDefine.ProtoFieldType.PFT_SInt64, common.miniproto.ProtoDefine.ProtoFieldType.PFT_String);
				}
			}
			if (has_m_uint64string()) {
				if (null != m_uint64string_) {
					bytes += common.miniproto.ProtoTool.KeyByteSize(76, common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited);
					bytes += common.miniproto.ProtoTool.MapByteSize(m_uint64string_, common.miniproto.ProtoDefine.ProtoFieldType.PFT_UInt64, common.miniproto.ProtoDefine.ProtoFieldType.PFT_String);
				}
			}
			if (has_m_stringstring()) {
				if (null != m_stringstring_) {
		...
		public void Code(OutputStream buf, int size) throws IOException {
			...
			if (has_m_sint32bool()) {
				if (null != m_sint32bool_) {
					common.miniproto.ProtoTool.KeyCode(2, common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited, buf);
					common.miniproto.ProtoTool.MapCode(m_sint32bool_, buf, common.miniproto.ProtoDefine.ProtoFieldType.PFT_SInt32, common.miniproto.ProtoDefine.ProtoFieldType.PFT_Bool);
				}
			}
			if (has_m_uint32bool()) {
				if (null != m_uint32bool_) {
					common.miniproto.ProtoTool.KeyCode(3, common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited, buf);
					common.miniproto.ProtoTool.MapCode(m_uint32bool_, buf, common.miniproto.ProtoDefine.ProtoFieldType.PFT_UInt32, common.miniproto.ProtoDefine.ProtoFieldType.PFT_Bool);
				}
			}
			if (has_m_int64bool()) {
				if (null != m_int64bool_) {
			...
			if (has_m_sint64bool()) {
				if (null != m_sint64bool_) {
					common.miniproto.ProtoTool.KeyCode(5, common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited, buf);
					common.miniproto.ProtoTool.MapCode(m_sint64bool_, buf, common.miniproto.ProtoDefine.ProtoFieldType.PFT_SInt64, common.miniproto.ProtoDefine.ProtoFieldType.PFT_Bool);
				}
			}
			if (has_m_uint64bool()) {
				if (null != m_uint64bool_) {
					common.miniproto.ProtoTool.KeyCode(6, common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited, buf);
					common.miniproto.ProtoTool.MapCode(m_uint64bool_, buf, common.miniproto.ProtoDefine.ProtoFieldType.PFT_UInt64, common.miniproto.ProtoDefine.ProtoFieldType.PFT_Bool);
				}
			}
			if (has_m_stringbool()) {
				if (null != m_stringbool_) {
			...
			if (has_m_sint32int32()) {
				if (null != m_sint32int32_) {
					common.miniproto.ProtoTool.KeyCode(9, common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited, buf);
					common.miniproto.ProtoTool.MapCode(m_sint32int32_, buf, common.miniproto.ProtoDefine.ProtoFieldType.PFT_SInt32, common.miniproto.ProtoDefine.ProtoFieldType.PFT_Int32);
				}
			}
			if (has_m_uint32int32()) {
				if (null != m_uint32int32_) {
					common.miniproto.ProtoTool.KeyCode(10, common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited, buf);
					common.miniproto.ProtoTool.MapCode(m_uint32int32_, buf, common.miniproto.ProtoDefine.ProtoFieldType.PFT_UInt32, common.miniproto.ProtoDefine.ProtoFieldType.PFT_Int32);
				}
			}
			if (has_m_int64int32()) {
				if (null != m_int64int32_) {
			...
			if (has_m_sint64int32()) {
				if (null != m_sint64int32_) {
					...
					common.miniproto.ProtoTool.MapCode(m_sint64int32_, buf, common.miniproto.ProtoDefine.ProtoFieldType.PFT_SInt64, common.miniproto.ProtoDefine.ProtoFieldType.PFT_Int32);
				}
			}
			if (has_m_uint64int32()) {
				if (null != m_uint64int32_) {
					common.miniproto.ProtoTool.KeyCode(13, common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited, buf);
					common.miniproto.ProtoTool.MapCode(m_uint64int32_, buf, common.miniproto.ProtoDefine.ProtoFieldType.PFT_UInt64, common.miniproto.ProtoDefine.ProtoFieldType.PFT_Int32);
				}
			}
			if (has_m_stringint32()) {
				if (null != m_stringint32_) {
			...
			if (has_m_int32sint32()) {
				if (null != m_int32sint32_) {
					...
					common.miniproto.ProtoTool.MapCode(m_int32sint32_, buf, common.miniproto.ProtoDefine.ProtoFieldType.PFT_Int32, common.miniproto.ProtoDefine.ProtoFieldType.PFT_SInt32);
				}
			}
			if (has_m_sint32sint32()) {
				if (null != m_sint32sint32_) {
					common.miniproto.ProtoTool.KeyCode(16, common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited, buf);
					common.miniproto.ProtoTool.MapCode(m_sint32sint32_, buf, common.miniproto.ProtoDefine.ProtoFieldType.PFT_SInt32, common.miniproto.ProtoDefine.ProtoFieldType.PFT_SInt32);
				}
			}
			if (has_m_uint32sint32()) {
				if (null != m_uint32sint32_) {
					common.miniproto.ProtoTool.KeyCode(17, common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited, buf);
					common.miniproto.ProtoTool.MapCode(m_uint32sint32_, buf, common.miniproto.ProtoDefine.ProtoFieldType.PFT_UInt32, common.miniproto.ProtoDefine.ProtoFieldType.PFT_SInt32);
				}
			}
			if (has_m_int64sint32()) {
				if (null != m_int64sint32_) {
					common.miniproto.ProtoTool.KeyCode(18, common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited, buf);
					common.miniproto.ProtoTool.MapCode(m_int64sint32_, buf, common.miniproto.ProtoDefine.ProtoFieldType.PFT_Int64, common.miniproto.ProtoDefine.ProtoFieldType.PFT_SInt32);
				}
			}
			if (has_m_sint64sint32()) {
				if (null != m_sint64sint32_) {
					common.miniproto.ProtoTool.KeyCode(19, common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited, buf);
					common.miniproto.ProtoTool.MapCode(m_sint64sint32_, buf, common.miniproto.ProtoDefine.ProtoFieldType.PFT_SInt64, common.miniproto.ProtoDefine.ProtoFieldType.PFT_SInt32);
				}
			}
			if (has_m_uint64sint32()) {
				if (null != m_uint64sint32_) {
					common.miniproto.ProtoTool.KeyCode(20, common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited, buf);
					common.miniproto.ProtoTool.MapCode(m_uint64sint32_, buf, common.miniproto.ProtoDefine.ProtoFieldType.PFT_UInt64, common.miniproto.ProtoDefine.ProtoFieldType.PFT_SInt32);
				}
			}
			if (has_m_stringsint32()) {
				if (null != m_stringsint32_) {
					common.miniproto.ProtoTool.KeyCode(21, common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited, buf);
					common.miniproto.ProtoTool.MapCode(m_stringsint32_, buf, common.miniproto.ProtoDefine.ProtoFieldType.PFT_String, common.miniproto.ProtoDefine.ProtoFieldType.PFT_SInt32);
				}
			}
			if (has_m_int32uint32()) {
				if (null != m_int32uint32_) {
					common.miniproto.ProtoTool.KeyCode(22, common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited, buf);
					common.miniproto.ProtoTool.MapCode(m_int32uint32_, buf, common.miniproto.ProtoDefine.ProtoFieldType.PFT_Int32, common.miniproto.ProtoDefine.ProtoFieldType.PFT_UInt32);
				}
			}
			if (has_m_sint32uint32()) {
				if (null != m_sint32uint32_) {
					common.miniproto.ProtoTool.KeyCode(23, common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited, buf);
					common.miniproto.ProtoTool.MapCode(m_sint32uint32_, buf, common.miniproto.ProtoDefine.ProtoFieldType.PFT_SInt32, common.miniproto.ProtoDefine.ProtoFieldType.PFT_UInt32);
				}
			}
			if (has_m_uint32uint32()) {
				if (null != m_uint32uint32_) {
					common.miniproto.ProtoTool.KeyCode(24, common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited, buf);
					common.miniproto.ProtoTool.MapCode(m_uint32uint32_, buf, common.miniproto.ProtoDefine.ProtoFieldType.PFT_UInt32, common.miniproto.ProtoDefine.ProtoFieldType.PFT_UInt32);
				}
			}
			if (has_m_int64uint32()) {
				if (null != m_int64uint32_) {
					common.miniproto.ProtoTool.KeyCode(25, common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited, buf);
					common.miniproto.ProtoTool.MapCode(m_int64uint32_, buf, common.miniproto.ProtoDefine.ProtoFieldType.PFT_Int64, common.miniproto.ProtoDefine.ProtoFieldType.PFT_UInt32);
				}
			}
			if (has_m_sint64uint32()) {
				if (null != m_sint64uint32_) {
					common.miniproto.ProtoTool.KeyCode(26, common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited, buf);
					common.miniproto.ProtoTool.MapCode(m_sint64uint32_, buf, common.miniproto.ProtoDefine.ProtoFieldType.PFT_SInt64, common.miniproto.ProtoDefine.ProtoFieldType.PFT_UInt32);
				}
			}
			if (has_m_uint64uint32()) {
				if (null != m_uint64uint32_) {
					common.miniproto.ProtoTool.KeyCode(27, common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited, buf);
					common.miniproto.ProtoTool.MapCode(m_uint64uint32_, buf, common.miniproto.ProtoDefine.ProtoFieldType.PFT_UInt64, common.miniproto.ProtoDefine.ProtoFieldType.PFT_UInt32);
				}
			}
			if (has_m_stringuint32()) {
				if (null != m_stringuint32_) {
					common.miniproto.ProtoTool.KeyCode(28, common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited, buf);
					common.miniproto.ProtoTool.MapCode(m_stringuint32_, buf, common.miniproto.ProtoDefine.ProtoFieldType.PFT_String, common.miniproto.ProtoDefine.ProtoFieldType.PFT_UInt32);
				}
			}
			if (has_m_int32int64()) {
				if (null != m_int32int64_) {
			...
			if (has_m_sint32int64()) {
				if (null != m_sint32int64_) {
					...
					common.miniproto.ProtoTool.MapCode(m_sint32int64_, buf, common.miniproto.ProtoDefine.ProtoFieldType.PFT_SInt32, common.miniproto.ProtoDefine.ProtoFieldType.PFT_Int64);
				}
			}
			if (has_m_uint32int64()) {
				if (null != m_uint32int64_) {
					common.miniproto.ProtoTool.KeyCode(31, common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited, buf);
					common.miniproto.ProtoTool.MapCode(m_uint32int64_, buf, common.miniproto.ProtoDefine.ProtoFieldType.PFT_UInt32, common.miniproto.ProtoDefine.ProtoFieldType.PFT_Int64);
				}
			}
			if (has_m_int64int64()) {
				if (null != m_int64int64_) {
			...
			if (has_m_sint64int64()) {
				if (null != m_sint64int64_) {
					...
					common.miniproto.ProtoTool.MapCode(m_sint64int64_, buf, common.miniproto.ProtoDefine.ProtoFieldType.PFT_SInt64, common.miniproto.ProtoDefine.ProtoFieldType.PFT_Int64);
				}
			}
			if (has_m_uint64int64()) {
				if (null != m_uint64int64_) {
					common.miniproto.ProtoTool.KeyCode(34, common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited, buf);
					common.miniproto.ProtoTool.MapCode(m_uint64int64_, buf, common.miniproto.ProtoDefine.ProtoFieldType.PFT_UInt64, common.miniproto.ProtoDefine.ProtoFieldType.PFT_Int64);
				}
			}
			if (has_m_stringint64()) {
				if (null != m_stringint64_) {
			...
			if (has_m_int32sint64()) {
				if (null != m_int32sint64_) {
					...
					common.miniproto.ProtoTool.MapCode(m_int32sint64_, buf, common.miniproto.ProtoDefine.ProtoFieldType.PFT_Int32, common.miniproto.ProtoDefine.ProtoFieldType.PFT_SInt64);
				}
			}
			if (has_m_sint32sint64()) {
				if (null != m_sint32sint64_) {
					common.miniproto.ProtoTool.KeyCode(37, common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited, buf);
					common.miniproto.ProtoTool.MapCode(m_sint32sint64_, buf, common.miniproto.ProtoDefine.ProtoFieldType.PFT_SInt32, common.miniproto.ProtoDefine.ProtoFieldType.PFT_SInt64);
				}
			}
			if (has_m_uint32sint64()) {
				if (null != m_uint32sint64_) {
					common.miniproto.ProtoTool.KeyCode(38, common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited, buf);
					common.miniproto.ProtoTool.MapCode(m_uint32sint64_, buf, common.miniproto.ProtoDefine.ProtoFieldType.PFT_UInt32, common.miniproto.ProtoDefine.ProtoFieldType.PFT_SInt64);
				}
			}
			if (has_m_int64sint64()) {
				if (null != m_int64sint64_) {
					common.miniproto.ProtoTool.KeyCode(39, common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited, buf);
					common.miniproto.ProtoTool.MapCode(m_int64sint64_, buf, common.miniproto.ProtoDefine.ProtoFieldType.PFT_Int64, common.miniproto.ProtoDefine.ProtoFieldType.PFT_SInt64);
				}
			}
			if (has_m_sint64sint64()) {
				if (null != m_sint64sint64_) {
					common.miniproto.ProtoTool.KeyCode(40, common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited, buf);
					common.miniproto.ProtoTool.MapCode(m_sint64sint64_, buf, common.miniproto.ProtoDefine.ProtoFieldType.PFT_SInt64, common.miniproto.ProtoDefine.ProtoFieldType.PFT_SInt64);
				}
			}
			if (has_m_uint64sint64()) {
				if (null != m_uint64sint64_) {
					common.miniproto.ProtoTool.KeyCode(41, common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited, buf);
					common.miniproto.ProtoTool.MapCode(m_uint64sint64_, buf, common.miniproto.ProtoDefine.ProtoFieldType.PFT_UInt64, common.miniproto.ProtoDefine.ProtoFieldType.PFT_SInt64);
				}
			}
			if (has_m_stringsint64()) {
				if (null != m_stringsint64_) {
					common.miniproto.ProtoTool.KeyCode(42, common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited, buf);
					common.miniproto.ProtoTool.MapCode(m_stringsint64_, buf, common.miniproto.ProtoDefine.ProtoFieldType.PFT_String, common.miniproto.ProtoDefine.ProtoFieldType.PFT_SInt64);
				}
			}
			if (has_m_int32uint64()) {
				if (null != m_int32uint64_) {
					common.miniproto.ProtoTool.KeyCode(43, common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited, buf);
					common.miniproto.ProtoTool.MapCode(m_int32uint64_, buf, common.miniproto.ProtoDefine.ProtoFieldType.PFT_Int32, common.miniproto.ProtoDefine.ProtoFieldType.PFT_UInt64);
				}
			}
			if (has_m_sint32uint64()) {
				if (null != m_sint32uint64_) {
					common.miniproto.ProtoTool.KeyCode(44, common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited, buf);
					common.miniproto.ProtoTool.MapCode(m_sint32uint64_, buf, common.miniproto.ProtoDefine.ProtoFieldType.PFT_SInt32, common.miniproto.ProtoDefine.ProtoFieldType.PFT_UInt64);
				}
			}
			if (has_m_uint32uint64()) {
				if (null != m_uint32uint64_) {
					common.miniproto.ProtoTool.KeyCode(45, common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited, buf);
					common.miniproto.ProtoTool.MapCode(m_uint32uint64_, buf, common.miniproto.ProtoDefine.ProtoFieldType.PFT_UInt32, common.miniproto.ProtoDefine.ProtoFieldType.PFT_UInt64);
				}
			}
			if (has_m_int64uint64()) {
				if (null != m_int64uint64_) {
					common.miniproto.ProtoTool.KeyCode(46, common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited, buf);
					common.miniproto.ProtoTool.MapCode(m_int64uint64_, buf, common.miniproto.ProtoDefine.ProtoFieldType.PFT_Int64, common.miniproto.ProtoDefine.ProtoFieldType.PFT_UInt64);
				}
			}
			if (has_m_sint64uint64()) {
				if (null != m_sint64uint64_) {
					common.miniproto.ProtoTool.KeyCode(47, common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited, buf);
					common.miniproto.ProtoTool.MapCode(m_sint64uint64_, buf, common.miniproto.ProtoDefine.ProtoFieldType.PFT_SInt64, common.miniproto.ProtoDefine.ProtoFieldType.PFT_UInt64);
				}
			}
			if (has_m_uint64uint64()) {
				if (null != m_uint64uint64_) {
					common.miniproto.ProtoTool.KeyCode(48, common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited, buf);
					common.miniproto.ProtoTool.MapCode(m_uint64uint64_, buf, common.miniproto.ProtoDefine.ProtoFieldType.PFT_UInt64, common.miniproto.ProtoDefine.ProtoFieldType.PFT_UInt64);
				}
			}
			if (has_m_stringuint64()) {
				if (null != m_stringuint64_) {
					common.miniproto.ProtoTool.KeyCode(49, common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited, buf);
					common.miniproto.ProtoTool.MapCode(m_stringuint64_, buf, common.miniproto.ProtoDefine.ProtoFieldType.PFT_String, common.miniproto.ProtoDefine.ProtoFieldType.PFT_UInt64);
				}
			}
			if (has_m_int32float()) {
				if (null != m_int32float_) {
			...
			if (has_m_sint32float()) {
				if (null != m_sint32float_) {
					...
					common.miniproto.ProtoTool.MapCode(m_sint32float_, buf, common.miniproto.ProtoDefine.ProtoFieldType.PFT_SInt32, common.miniproto.ProtoDefine.ProtoFieldType.PFT_Float);
				}
			}
			if (has_m_uint32float()) {
				if (null != m_uint32float_) {
					common.miniproto.ProtoTool.KeyCode(52, common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited, buf);
					common.miniproto.ProtoTool.MapCode(m_uint32float_, buf, common.miniproto.ProtoDefine.ProtoFieldType.PFT_UInt32, common.miniproto.ProtoDefine.ProtoFieldType.PFT_Float);
				}
			}
			if (has_m_int64float()) {
				if (null != m_int64float_) {
			...
			if (has_m_sint64float()) {
				if (null != m_sint64float_) {
					...
					common.miniproto.ProtoTool.MapCode(m_sint64float_, buf, common.miniproto.ProtoDefine.ProtoFieldType.PFT_SInt64, common.miniproto.ProtoDefine.ProtoFieldType.PFT_Float);
				}
			}
			if (has_m_uint64float()) {
				if (null != m_uint64float_) {
					common.miniproto.ProtoTool.KeyCode(55, common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited, buf);
					common.miniproto.ProtoTool.MapCode(m_uint64float_, buf, common.miniproto.ProtoDefine.ProtoFieldType.PFT_UInt64, common.miniproto.ProtoDefine.ProtoFieldType.PFT_Float);
				}
			}
			if (has_m_stringfloat()) {
				if (null != m_stringfloat_) {
			...
			if (has_m_sint32double()) {
				if (null != m_sint32double_) {
					...
					common.miniproto.ProtoTool.MapCode(m_sint32double_, buf, common.miniproto.ProtoDefine.ProtoFieldType.PFT_SInt32, common.miniproto.ProtoDefine.ProtoFieldType.PFT_Double);
				}
			}
			if (has_m_uint32double()) {
				if (null != m_uint32double_) {
					common.miniproto.ProtoTool.KeyCode(59, common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited, buf);
					common.miniproto.ProtoTool.MapCode(m_uint32double_, buf, common.miniproto.ProtoDefine.ProtoFieldType.PFT_UInt32, common.miniproto.ProtoDefine.ProtoFieldType.PFT_Double);
				}
			}
			if (has_m_int64double()) {
				if (null != m_int64double_) {
			...
			if (has_m_sint64double()) {
				if (null != m_sint64double_) {
					...
					common.miniproto.ProtoTool.MapCode(m_sint64double_, buf, common.miniproto.ProtoDefine.ProtoFieldType.PFT_SInt64, common.miniproto.ProtoDefine.ProtoFieldType.PFT_Double);
				}
			}
			if (has_m_uint64double()) {
				if (null != m_uint64double_) {
					common.miniproto.ProtoTool.KeyCode(62, common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited, buf);
					common.miniproto.ProtoTool.MapCode(m_uint64double_, buf, common.miniproto.ProtoDefine.ProtoFieldType.PFT_UInt64, common.miniproto.ProtoDefine.ProtoFieldType.PFT_Double);
				}
			}
			if (has_m_stringdouble()) {
				if (null != m_stringdouble_) {
			...
			if (has_m_sint32enum()) {
				if (null != m_sint32enum_) {
					...
					common.miniproto.ProtoTool.MapCode(m_sint32enum_, buf, common.miniproto.ProtoDefine.ProtoFieldType.PFT_SInt32, common.miniproto.ProtoDefine.ProtoFieldType.PFT_Enum);
				}
			}
			if (has_m_uint32enum()) {
				if (null != m_uint32enum_) {
					common.miniproto.ProtoTool.KeyCode(66, common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited, buf);
					common.miniproto.ProtoTool.MapCode(m_uint32enum_, buf, common.miniproto.ProtoDefine.ProtoFieldType.PFT_UInt32, common.miniproto.ProtoDefine.ProtoFieldType.PFT_Enum);
				}
			}
			if (has_m_int64enum()) {
				if (null != m_int64enum_) {
			...
			if (has_m_sint64enum()) {
				if (null != m_sint64enum_) {
					...
					common.miniproto.ProtoTool.MapCode(m_sint64enum_, buf, common.miniproto.ProtoDefine.ProtoFieldType.PFT_SInt64, common.miniproto.ProtoDefine.ProtoFieldType.PFT_Enum);
				}
			}
			if (has_m_uint64enum()) {
				if (null != m_uint64enum_) {
					common.miniproto.ProtoTool.KeyCode(69, common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited, buf);
					common.miniproto.ProtoTool.MapCode(m_uint64enum_, buf, common.miniproto.ProtoDefine.ProtoFieldType.PFT_UInt64, common.miniproto.ProtoDefine.ProtoFieldType.PFT_Enum);
				}
			}
			if (has_m_stringenum()) {
				if (null != m_stringenum_) {
			...
			if (has_m_sint32string()) {
				if (null != m_sint32string_) {
					...
					common.miniproto.ProtoTool.MapCode(m_sint32string_, buf, common.miniproto.ProtoDefine.ProtoFieldType.PFT_SInt32, common.miniproto.ProtoDefine.ProtoFieldType.PFT_String);
				}
			}
			if (has_m_uint32string()) {
				if (null != m_uint32string_) {
					common.miniproto.ProtoTool.KeyCode(73, common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited, buf);
					common.miniproto.ProtoTool.MapCode(m_uint32string_, buf, common.miniproto.ProtoDefine.ProtoFieldType.PFT_UInt32, common.miniproto.ProtoDefine.ProtoFieldType.PFT_String);
				}
			}
			if (has_m_int64string()) {
				if (null != m_int64string_) {
			...
			if (has_m_sint64string()) {
				if (null != m_sint64string_) {
					...
					common.miniproto.ProtoTool.MapCode(m_sint64string_, buf, common.miniproto.ProtoDefine.ProtoFieldType.PFT_SInt64, common.miniproto.ProtoDefine.ProtoFieldType.PFT_String);
				}
			}
			if (has_m_uint64string()) {
				if (null != m_uint64string_) {
					common.miniproto.ProtoTool.KeyCode(76, common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited, buf);
					common.miniproto.ProtoTool.MapCode(m_uint64string_, buf, common.miniproto.ProtoDefine.ProtoFieldType.PFT_UInt64, common.miniproto.ProtoDefine.ProtoFieldType.PFT_String);
				}
			}
			if (has_m_stringstring()) {
				if (null != m_stringstring_) {
			...
			while ((oldPos - buf.available()) < size) {
				...
				switch (key) {
					...
					case 2 << 3 | common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited_VALUE : {
						...
						if (null != m_sint32bool_) {
							common.miniproto.ProtoTool.MapDecode(m_sint32bool_, buf, common.miniproto.ProtoDefine.ProtoFieldType.PFT_SInt32, common.miniproto.ProtoDefine.ProtoFieldType.PFT_Bool);
							set_has_m_sint32bool();
						} else {
							common.miniproto.ProtoTool.UnknownDecode(type, buf);
						}
					...
					case 3 << 3 | common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited_VALUE : {
						...
						if (null != m_uint32bool_) {
							common.miniproto.ProtoTool.MapDecode(m_uint32bool_, buf, common.miniproto.ProtoDefine.ProtoFieldType.PFT_UInt32, common.miniproto.ProtoDefine.ProtoFieldType.PFT_Bool);
							set_has_m_uint32bool();
						} else {
							common.miniproto.ProtoTool.UnknownDecode(type, buf);
						}
					...
					case 5 << 3 | common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited_VALUE : {
						...
						if (null != m_sint64bool_) {
							common.miniproto.ProtoTool.MapDecode(m_sint64bool_, buf, common.miniproto.ProtoDefine.ProtoFieldType.PFT_SInt64, common.miniproto.ProtoDefine.ProtoFieldType.PFT_Bool);
							set_has_m_sint64bool();
						} else {
							common.miniproto.ProtoTool.UnknownDecode(type, buf);
						}
					...
					case 6 << 3 | common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited_VALUE : {
						...
						if (null != m_uint64bool_) {
							common.miniproto.ProtoTool.MapDecode(m_uint64bool_, buf, common.miniproto.ProtoDefine.ProtoFieldType.PFT_UInt64, common.miniproto.ProtoDefine.ProtoFieldType.PFT_Bool);
							set_has_m_uint64bool();
						} else {
							common.miniproto.ProtoTool.UnknownDecode(type, buf);
						}
					...
					case 9 << 3 | common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited_VALUE : {
						...
						if (null != m_sint32int32_) {
							common.miniproto.ProtoTool.MapDecode(m_sint32int32_, buf, common.miniproto.ProtoDefine.ProtoFieldType.PFT_SInt32, common.miniproto.ProtoDefine.ProtoFieldType.PFT_Int32);
							set_has_m_sint32int32();
						} else {
							common.miniproto.ProtoTool.UnknownDecode(type, buf);
						}
					...
					case 10 << 3 | common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited_VALUE : {
						...
						if (null != m_uint32int32_) {
							common.miniproto.ProtoTool.MapDecode(m_uint32int32_, buf, common.miniproto.ProtoDefine.ProtoFieldType.PFT_UInt32, common.miniproto.ProtoDefine.ProtoFieldType.PFT_Int32);
							set_has_m_uint32int32();
						} else {
							common.miniproto.ProtoTool.UnknownDecode(type, buf);
						}
					...
					case 12 << 3 | common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited_VALUE : {
						...
						if (null != m_sint64int32_) {
							common.miniproto.ProtoTool.MapDecode(m_sint64int32_, buf, common.miniproto.ProtoDefine.ProtoFieldType.PFT_SInt64, common.miniproto.ProtoDefine.ProtoFieldType.PFT_Int32);
							set_has_m_sint64int32();
						} else {
							common.miniproto.ProtoTool.UnknownDecode(type, buf);
						}
					...
					case 13 << 3 | common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited_VALUE : {
						...
						if (null != m_uint64int32_) {
							common.miniproto.ProtoTool.MapDecode(m_uint64int32_, buf, common.miniproto.ProtoDefine.ProtoFieldType.PFT_UInt64, common.miniproto.ProtoDefine.ProtoFieldType.PFT_Int32);
							set_has_m_uint64int32();
						} else {
							common.miniproto.ProtoTool.UnknownDecode(type, buf);
						}
					...
					case 15 << 3 | common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited_VALUE : {
						...
						if (null != m_int32sint32_) {
							common.miniproto.ProtoTool.MapDecode(m_int32sint32_, buf, common.miniproto.ProtoDefine.ProtoFieldType.PFT_Int32, common.miniproto.ProtoDefine.ProtoFieldType.PFT_SInt32);
							set_has_m_int32sint32();
						} else {
							common.miniproto.ProtoTool.UnknownDecode(type, buf);
						}
					...
					case 16 << 3 | common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited_VALUE : {
						...
						if (null != m_sint32sint32_) {
							common.miniproto.ProtoTool.MapDecode(m_sint32sint32_, buf, common.miniproto.ProtoDefine.ProtoFieldType.PFT_SInt32, common.miniproto.ProtoDefine.ProtoFieldType.PFT_SInt32);
							set_has_m_sint32sint32();
						} else {
							common.miniproto.ProtoTool.UnknownDecode(type, buf);
						}
					...
					case 17 << 3 | common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited_VALUE : {
						...
						if (null != m_uint32sint32_) {
							common.miniproto.ProtoTool.MapDecode(m_uint32sint32_, buf, common.miniproto.ProtoDefine.ProtoFieldType.PFT_UInt32, common.miniproto.ProtoDefine.ProtoFieldType.PFT_SInt32);
							set_has_m_uint32sint32();
						} else {
							common.miniproto.ProtoTool.UnknownDecode(type, buf);
						}
					...
					case 18 << 3 | common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited_VALUE : {
						...
						if (null != m_int64sint32_) {
							common.miniproto.ProtoTool.MapDecode(m_int64sint32_, buf, common.miniproto.ProtoDefine.ProtoFieldType.PFT_Int64, common.miniproto.ProtoDefine.ProtoFieldType.PFT_SInt32);
							set_has_m_int64sint32();
						} else {
							common.miniproto.ProtoTool.UnknownDecode(type, buf);
						}
					...
					case 19 << 3 | common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited_VALUE : {
						...
						if (null != m_sint64sint32_) {
							common.miniproto.ProtoTool.MapDecode(m_sint64sint32_, buf, common.miniproto.ProtoDefine.ProtoFieldType.PFT_SInt64, common.miniproto.ProtoDefine.ProtoFieldType.PFT_SInt32);
							set_has_m_sint64sint32();
						} else {
							common.miniproto.ProtoTool.UnknownDecode(type, buf);
						}
					...
					case 20 << 3 | common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited_VALUE : {
						...
						if (null != m_uint64sint32_) {
							common.miniproto.ProtoTool.MapDecode(m_uint64sint32_, buf, common.miniproto.ProtoDefine.ProtoFieldType.PFT_UInt64, common.miniproto.ProtoDefine.ProtoFieldType.PFT_SInt32);
							set_has_m_uint64sint32();
						} else {
							common.miniproto.ProtoTool.UnknownDecode(type, buf);
						}
					...
					case 21 << 3 | common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited_VALUE : {
						...
						if (null != m_stringsint32_) {
							common.miniproto.ProtoTool.MapDecode(m_stringsint32_, buf, common.miniproto.ProtoDefine.ProtoFieldType.PFT_String, common.miniproto.ProtoDefine.ProtoFieldType.PFT_SInt32);
							set_has_m_stringsint32();
						} else {
							common.miniproto.ProtoTool.UnknownDecode(type, buf);
						}
					...
					case 22 << 3 | common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited_VALUE : {
						...
						if (null != m_int32uint32_) {
							common.miniproto.ProtoTool.MapDecode(m_int32uint32_, buf, common.miniproto.ProtoDefine.ProtoFieldType.PFT_Int32, common.miniproto.ProtoDefine.ProtoFieldType.PFT_UInt32);
							set_has_m_int32uint32();
						} else {
							common.miniproto.ProtoTool.UnknownDecode(type, buf);
						}
					...
					case 23 << 3 | common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited_VALUE : {
						...
						if (null != m_sint32uint32_) {
							common.miniproto.ProtoTool.MapDecode(m_sint32uint32_, buf, common.miniproto.ProtoDefine.ProtoFieldType.PFT_SInt32, common.miniproto.ProtoDefine.ProtoFieldType.PFT_UInt32);
							set_has_m_sint32uint32();
						} else {
							common.miniproto.ProtoTool.UnknownDecode(type, buf);
						}
					...
					case 24 << 3 | common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited_VALUE : {
						...
						if (null != m_uint32uint32_) {
							common.miniproto.ProtoTool.MapDecode(m_uint32uint32_, buf, common.miniproto.ProtoDefine.ProtoFieldType.PFT_UInt32, common.miniproto.ProtoDefine.ProtoFieldType.PFT_UInt32);
							set_has_m_uint32uint32();
						} else {
							common.miniproto.ProtoTool.UnknownDecode(type, buf);
						}
					...
					case 25 << 3 | common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited_VALUE : {
						...
						if (null != m_int64uint32_) {
							common.miniproto.ProtoTool.MapDecode(m_int64uint32_, buf, common.miniproto.ProtoDefine.ProtoFieldType.PFT_Int64, common.miniproto.ProtoDefine.ProtoFieldType.PFT_UInt32);
							set_has_m_int64uint32();
						} else {
							common.miniproto.ProtoTool.UnknownDecode(type, buf);
						}
					...
					case 26 << 3 | common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited_VALUE : {
						...
						if (null != m_sint64uint32_) {
							common.miniproto.ProtoTool.MapDecode(m_sint64uint32_, buf, common.miniproto.ProtoDefine.ProtoFieldType.PFT_SInt64, common.miniproto.ProtoDefine.ProtoFieldType.PFT_UInt32);
							set_has_m_sint64uint32();
						} else {
							common.miniproto.ProtoTool.UnknownDecode(type, buf);
						}
					...
					case 27 << 3 | common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited_VALUE : {
						...
						if (null != m_uint64uint32_) {
							common.miniproto.ProtoTool.MapDecode(m_uint64uint32_, buf, common.miniproto.ProtoDefine.ProtoFieldType.PFT_UInt64, common.miniproto.ProtoDefine.ProtoFieldType.PFT_UInt32);
							set_has_m_uint64uint32();
						} else {
							common.miniproto.ProtoTool.UnknownDecode(type, buf);
						}
					...
					case 28 << 3 | common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited_VALUE : {
						...
						if (null != m_stringuint32_) {
							common.miniproto.ProtoTool.MapDecode(m_stringuint32_, buf, common.miniproto.ProtoDefine.ProtoFieldType.PFT_String, common.miniproto.ProtoDefine.ProtoFieldType.PFT_UInt32);
							set_has_m_stringuint32();
						} else {
							common.miniproto.ProtoTool.UnknownDecode(type, buf);
						}
					...
					case 30 << 3 | common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited_VALUE : {
						...
						if (null != m_sint32int64_) {
							common.miniproto.ProtoTool.MapDecode(m_sint32int64_, buf, common.miniproto.ProtoDefine.ProtoFieldType.PFT_SInt32, common.miniproto.ProtoDefine.ProtoFieldType.PFT_Int64);
							set_has_m_sint32int64();
						} else {
							common.miniproto.ProtoTool.UnknownDecode(type, buf);
						}
					...
					case 31 << 3 | common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited_VALUE : {
						...
						if (null != m_uint32int64_) {
							common.miniproto.ProtoTool.MapDecode(m_uint32int64_, buf, common.miniproto.ProtoDefine.ProtoFieldType.PFT_UInt32, common.miniproto.ProtoDefine.ProtoFieldType.PFT_Int64);
							set_has_m_uint32int64();
						} else {
							common.miniproto.ProtoTool.UnknownDecode(type, buf);
						}
					...
					case 33 << 3 | common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited_VALUE : {
						...
						if (null != m_sint64int64_) {
							common.miniproto.ProtoTool.MapDecode(m_sint64int64_, buf, common.miniproto.ProtoDefine.ProtoFieldType.PFT_SInt64, common.miniproto.ProtoDefine.ProtoFieldType.PFT_Int64);
							set_has_m_sint64int64();
						} else {
							common.miniproto.ProtoTool.UnknownDecode(type, buf);
						}
					...
					case 34 << 3 | common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited_VALUE : {
						...
						if (null != m_uint64int64_) {
							common.miniproto.ProtoTool.MapDecode(m_uint64int64_, buf, common.miniproto.ProtoDefine.ProtoFieldType.PFT_UInt64, common.miniproto.ProtoDefine.ProtoFieldType.PFT_Int64);
							set_has_m_uint64int64();
						} else {
							common.miniproto.ProtoTool.UnknownDecode(type, buf);
						}
					...
					case 36 << 3 | common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited_VALUE : {
						...
						if (null != m_int32sint64_) {
							common.miniproto.ProtoTool.MapDecode(m_int32sint64_, buf, common.miniproto.ProtoDefine.ProtoFieldType.PFT_Int32, common.miniproto.ProtoDefine.ProtoFieldType.PFT_SInt64);
							set_has_m_int32sint64();
						} else {
							common.miniproto.ProtoTool.UnknownDecode(type, buf);
						}
					...
					case 37 << 3 | common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited_VALUE : {
						...
						if (null != m_sint32sint64_) {
							common.miniproto.ProtoTool.MapDecode(m_sint32sint64_, buf, common.miniproto.ProtoDefine.ProtoFieldType.PFT_SInt32, common.miniproto.ProtoDefine.ProtoFieldType.PFT_SInt64);
							set_has_m_sint32sint64();
						} else {
							common.miniproto.ProtoTool.UnknownDecode(type, buf);
						}
					...
					case 38 << 3 | common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited_VALUE : {
						...
						if (null != m_uint32sint64_) {
							common.miniproto.ProtoTool.MapDecode(m_uint32sint64_, buf, common.miniproto.ProtoDefine.ProtoFieldType.PFT_UInt32, common.miniproto.ProtoDefine.ProtoFieldType.PFT_SInt64);
							set_has_m_uint32sint64();
						} else {
							common.miniproto.ProtoTool.UnknownDecode(type, buf);
						}
					...
					case 39 << 3 | common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited_VALUE : {
						...
						if (null != m_int64sint64_) {
							common.miniproto.ProtoTool.MapDecode(m_int64sint64_, buf, common.miniproto.ProtoDefine.ProtoFieldType.PFT_Int64, common.miniproto.ProtoDefine.ProtoFieldType.PFT_SInt64);
							set_has_m_int64sint64();
						} else {
							common.miniproto.ProtoTool.UnknownDecode(type, buf);
						}
					...
					case 40 << 3 | common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited_VALUE : {
						...
						if (null != m_sint64sint64_) {
							common.miniproto.ProtoTool.MapDecode(m_sint64sint64_, buf, common.miniproto.ProtoDefine.ProtoFieldType.PFT_SInt64, common.miniproto.ProtoDefine.ProtoFieldType.PFT_SInt64);
							set_has_m_sint64sint64();
						} else {
							common.miniproto.ProtoTool.UnknownDecode(type, buf);
						}
					...
					case 41 << 3 | common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited_VALUE : {
						...
						if (null != m_uint64sint64_) {
							common.miniproto.ProtoTool.MapDecode(m_uint64sint64_, buf, common.miniproto.ProtoDefine.ProtoFieldType.PFT_UInt64, common.miniproto.ProtoDefine.ProtoFieldType.PFT_SInt64);
							set_has_m_uint64sint64();
						} else {
							common.miniproto.ProtoTool.UnknownDecode(type, buf);
						}
					...
					case 42 << 3 | common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited_VALUE : {
						...
						if (null != m_stringsint64_) {
							common.miniproto.ProtoTool.MapDecode(m_stringsint64_, buf, common.miniproto.ProtoDefine.ProtoFieldType.PFT_String, common.miniproto.ProtoDefine.ProtoFieldType.PFT_SInt64);
							set_has_m_stringsint64();
						} else {
							common.miniproto.ProtoTool.UnknownDecode(type, buf);
						}
					...
					case 43 << 3 | common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited_VALUE : {
						...
						if (null != m_int32uint64_) {
							common.miniproto.ProtoTool.MapDecode(m_int32uint64_, buf, common.miniproto.ProtoDefine.ProtoFieldType.PFT_Int32, common.miniproto.ProtoDefine.ProtoFieldType.PFT_UInt64);
							set_has_m_int32uint64();
						} else {
							common.miniproto.ProtoTool.UnknownDecode(type, buf);
						}
					...
					case 44 << 3 | common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited_VALUE : {
						...
						if (null != m_sint32uint64_) {
							common.miniproto.ProtoTool.MapDecode(m_sint32uint64_, buf, common.miniproto.ProtoDefine.ProtoFieldType.PFT_SInt32, common.miniproto.ProtoDefine.ProtoFieldType.PFT_UInt64);
							set_has_m_sint32uint64();
						} else {
							common.miniproto.ProtoTool.UnknownDecode(type, buf);
						}
					...
					case 45 << 3 | common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited_VALUE : {
						...
						if (null != m_uint32uint64_) {
							common.miniproto.ProtoTool.MapDecode(m_uint32uint64_, buf, common.miniproto.ProtoDefine.ProtoFieldType.PFT_UInt32, common.miniproto.ProtoDefine.ProtoFieldType.PFT_UInt64);
							set_has_m_uint32uint64();
						} else {
							common.miniproto.ProtoTool.UnknownDecode(type, buf);
						}
					...
					case 46 << 3 | common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited_VALUE : {
						...
						if (null != m_int64uint64_) {
							common.miniproto.ProtoTool.MapDecode(m_int64uint64_, buf, common.miniproto.ProtoDefine.ProtoFieldType.PFT_Int64, common.miniproto.ProtoDefine.ProtoFieldType.PFT_UInt64);
							set_has_m_int64uint64();
						} else {
							common.miniproto.ProtoTool.UnknownDecode(type, buf);
						}
					...
					case 47 << 3 | common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited_VALUE : {
						...
						if (null != m_sint64uint64_) {
							common.miniproto.ProtoTool.MapDecode(m_sint64uint64_, buf, common.miniproto.ProtoDefine.ProtoFieldType.PFT_SInt64, common.miniproto.ProtoDefine.ProtoFieldType.PFT_UInt64);
							set_has_m_sint64uint64();
						} else {
							common.miniproto.ProtoTool.UnknownDecode(type, buf);
						}
					...
					case 48 << 3 | common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited_VALUE : {
						...
						if (null != m_uint64uint64_) {
							common.miniproto.ProtoTool.MapDecode(m_uint64uint64_, buf, common.miniproto.ProtoDefine.ProtoFieldType.PFT_UInt64, common.miniproto.ProtoDefine.ProtoFieldType.PFT_UInt64);
							set_has_m_uint64uint64();
						} else {
							common.miniproto.ProtoTool.UnknownDecode(type, buf);
						}
					...
					case 49 << 3 | common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited_VALUE : {
						...
						if (null != m_stringuint64_) {
							common.miniproto.ProtoTool.MapDecode(m_stringuint64_, buf, common.miniproto.ProtoDefine.ProtoFieldType.PFT_String, common.miniproto.ProtoDefine.ProtoFieldType.PFT_UInt64);
							set_has_m_stringuint64();
						} else {
							common.miniproto.ProtoTool.UnknownDecode(type, buf);
						}
					...
					case 51 << 3 | common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited_VALUE : {
						...
						if (null != m_sint32float_) {
							common.miniproto.ProtoTool.MapDecode(m_sint32float_, buf, common.miniproto.ProtoDefine.ProtoFieldType.PFT_SInt32, common.miniproto.ProtoDefine.ProtoFieldType.PFT_Float);
							set_has_m_sint32float();
						} else {
							common.miniproto.ProtoTool.UnknownDecode(type, buf);
						}
					...
					case 52 << 3 | common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited_VALUE : {
						...
						if (null != m_uint32float_) {
							common.miniproto.ProtoTool.MapDecode(m_uint32float_, buf, common.miniproto.ProtoDefine.ProtoFieldType.PFT_UInt32, common.miniproto.ProtoDefine.ProtoFieldType.PFT_Float);
							set_has_m_uint32float();
						} else {
							common.miniproto.ProtoTool.UnknownDecode(type, buf);
						}
					...
					case 54 << 3 | common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited_VALUE : {
						...
						if (null != m_sint64float_) {
							common.miniproto.ProtoTool.MapDecode(m_sint64float_, buf, common.miniproto.ProtoDefine.ProtoFieldType.PFT_SInt64, common.miniproto.ProtoDefine.ProtoFieldType.PFT_Float);
							set_has_m_sint64float();
						} else {
							common.miniproto.ProtoTool.UnknownDecode(type, buf);
						}
					...
					case 55 << 3 | common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited_VALUE : {
						...
						if (null != m_uint64float_) {
							common.miniproto.ProtoTool.MapDecode(m_uint64float_, buf, common.miniproto.ProtoDefine.ProtoFieldType.PFT_UInt64, common.miniproto.ProtoDefine.ProtoFieldType.PFT_Float);
							set_has_m_uint64float();
						} else {
							common.miniproto.ProtoTool.UnknownDecode(type, buf);
						}
					...
					case 58 << 3 | common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited_VALUE : {
						...
						if (null != m_sint32double_) {
							common.miniproto.ProtoTool.MapDecode(m_sint32double_, buf, common.miniproto.ProtoDefine.ProtoFieldType.PFT_SInt32, common.miniproto.ProtoDefine.ProtoFieldType.PFT_Double);
							set_has_m_sint32double();
						} else {
							common.miniproto.ProtoTool.UnknownDecode(type, buf);
						}
					...
					case 59 << 3 | common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited_VALUE : {
						...
						if (null != m_uint32double_) {
							common.miniproto.ProtoTool.MapDecode(m_uint32double_, buf, common.miniproto.ProtoDefine.ProtoFieldType.PFT_UInt32, common.miniproto.ProtoDefine.ProtoFieldType.PFT_Double);
							set_has_m_uint32double();
						} else {
							common.miniproto.ProtoTool.UnknownDecode(type, buf);
						}
					...
					case 61 << 3 | common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited_VALUE : {
						...
						if (null != m_sint64double_) {
							common.miniproto.ProtoTool.MapDecode(m_sint64double_, buf, common.miniproto.ProtoDefine.ProtoFieldType.PFT_SInt64, common.miniproto.ProtoDefine.ProtoFieldType.PFT_Double);
							set_has_m_sint64double();
						} else {
							common.miniproto.ProtoTool.UnknownDecode(type, buf);
						}
					...
					case 62 << 3 | common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited_VALUE : {
						...
						if (null != m_uint64double_) {
							common.miniproto.ProtoTool.MapDecode(m_uint64double_, buf, common.miniproto.ProtoDefine.ProtoFieldType.PFT_UInt64, common.miniproto.ProtoDefine.ProtoFieldType.PFT_Double);
							set_has_m_uint64double();
						} else {
							common.miniproto.ProtoTool.UnknownDecode(type, buf);
						}
					...
					case 65 << 3 | common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited_VALUE : {
						...
						if (null != m_sint32enum_) {
							common.miniproto.ProtoTool.MapDecode(m_sint32enum_, buf, common.miniproto.ProtoDefine.ProtoFieldType.PFT_SInt32, common.miniproto.ProtoDefine.ProtoFieldType.PFT_Enum);
							set_has_m_sint32enum();
						} else {
							common.miniproto.ProtoTool.UnknownDecode(type, buf);
						}
					...
					case 66 << 3 | common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited_VALUE : {
						...
						if (null != m_uint32enum_) {
							common.miniproto.ProtoTool.MapDecode(m_uint32enum_, buf, common.miniproto.ProtoDefine.ProtoFieldType.PFT_UInt32, common.miniproto.ProtoDefine.ProtoFieldType.PFT_Enum);
							set_has_m_uint32enum();
						} else {
							common.miniproto.ProtoTool.UnknownDecode(type, buf);
						}
					...
					case 68 << 3 | common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited_VALUE : {
						...
						if (null != m_sint64enum_) {
							common.miniproto.ProtoTool.MapDecode(m_sint64enum_, buf, common.miniproto.ProtoDefine.ProtoFieldType.PFT_SInt64, common.miniproto.ProtoDefine.ProtoFieldType.PFT_Enum);
							set_has_m_sint64enum();
						} else {
							common.miniproto.ProtoTool.UnknownDecode(type, buf);
						}
					...
					case 69 << 3 | common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited_VALUE : {
						...
						if (null != m_uint64enum_) {
							common.miniproto.ProtoTool.MapDecode(m_uint64enum_, buf, common.miniproto.ProtoDefine.ProtoFieldType.PFT_UInt64, common.miniproto.ProtoDefine.ProtoFieldType.PFT_Enum);
							set_has_m_uint64enum();
						} else {
							common.miniproto.ProtoTool.UnknownDecode(type, buf);
						}
					...
					case 72 << 3 | common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited_VALUE : {
						...
						if (null != m_sint32string_) {
							common.miniproto.ProtoTool.MapDecode(m_sint32string_, buf, common.miniproto.ProtoDefine.ProtoFieldType.PFT_SInt32, common.miniproto.ProtoDefine.ProtoFieldType.PFT_String);
							set_has_m_sint32string();
						} else {
							common.miniproto.ProtoTool.UnknownDecode(type, buf);
						}
					...
					case 73 << 3 | common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited_VALUE : {
						...
						if (null != m_uint32string_) {
							common.miniproto.ProtoTool.MapDecode(m_uint32string_, buf, common.miniproto.ProtoDefine.ProtoFieldType.PFT_UInt32, common.miniproto.ProtoDefine.ProtoFieldType.PFT_String);
							set_has_m_uint32string();
						} else {
							common.miniproto.ProtoTool.UnknownDecode(type, buf);
						}
					...
					case 75 << 3 | common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited_VALUE : {
						...
						if (null != m_sint64string_) {
							common.miniproto.ProtoTool.MapDecode(m_sint64string_, buf, common.miniproto.ProtoDefine.ProtoFieldType.PFT_SInt64, common.miniproto.ProtoDefine.ProtoFieldType.PFT_String);
							set_has_m_sint64string();
						} else {
							common.miniproto.ProtoTool.UnknownDecode(type, buf);
						}
					...
					case 76 << 3 | common.miniproto.ProtoDefine.ProtoWireType.PWT_LengthDelimited_VALUE : {
						...
						if (null != m_uint64string_) {
							common.miniproto.ProtoTool.MapDecode(m_uint64string_, buf, common.miniproto.ProtoDefine.ProtoFieldType.PFT_UInt64, common.miniproto.ProtoDefine.ProtoFieldType.PFT_String);
							set_has_m_uint64string();
						} else {
							common.miniproto.ProtoTool.UnknownDecode(type, buf);
						}

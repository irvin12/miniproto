...
public class Proto1 {
	...
	public static class MsgTestSingular extends common.miniproto.ProtoBase {
		...
		public int ByteSize() throws IOException {
			...
			if (has_m_sint32()) {
				bytes += common.miniproto.ProtoTool.KeyByteSize(3, common.miniproto.ProtoDefine.ProtoWireType.PWT_Varint);
				bytes += common.miniproto.ProtoTool.SInt32ByteSize(m_sint32_);
			}
			if (has_m_uint32()) {
				bytes += common.miniproto.ProtoTool.KeyByteSize(4, common.miniproto.ProtoDefine.ProtoWireType.PWT_Varint);
			...
			if (has_m_sint64()) {
				bytes += common.miniproto.ProtoTool.KeyByteSize(6, common.miniproto.ProtoDefine.ProtoWireType.PWT_Varint);
				bytes += common.miniproto.ProtoTool.SInt64ByteSize(m_sint64_);
			}
			if (has_m_uint64()) {
				bytes += common.miniproto.ProtoTool.KeyByteSize(7, common.miniproto.ProtoDefine.ProtoWireType.PWT_Varint);
		...
		public void Code(OutputStream buf, int size) throws IOException {
			...
			if (has_m_sint32()) {
				common.miniproto.ProtoTool.KeyCode(3, common.miniproto.ProtoDefine.ProtoWireType.PWT_Varint, buf);
				common.miniproto.ProtoTool.SInt32Code(m_sint32_, buf);
			}
			if (has_m_uint32()) {
				common.miniproto.ProtoTool.KeyCode(4, common.miniproto.ProtoDefine.ProtoWireType.PWT_Varint, buf);
				common.miniproto.ProtoTool.UInt32Code(m_uint32_, buf);
			}
			if (has_m_int64()) {
			...
			if (has_m_sint64()) {
				common.miniproto.ProtoTool.KeyCode(6, common.miniproto.ProtoDefine.ProtoWireType.PWT_Varint, buf);
				common.miniproto.ProtoTool.SInt64Code(m_sint64_, buf);
			}
			if (has_m_uint64()) {
				common.miniproto.ProtoTool.KeyCode(7, common.miniproto.ProtoDefine.ProtoWireType.PWT_Varint, buf);
				common.miniproto.ProtoTool.UInt64Code(m_uint64_, buf);
			}
			if (has_m_float()) {
		...
		public void Decode(InputStream buf, int size) throws IOException {
			...
			while ((oldPos - buf.available()) < size) {
				...
				switch (key) {
					...
					break;
					case 3 << 3 | common.miniproto.ProtoDefine.ProtoWireType.PWT_Varint_VALUE : {
						m_sint32_ = common.miniproto.ProtoTool.SInt32Decode(buf);
						set_has_m_sint32();
					}
					break;
					case 4 << 3 | common.miniproto.ProtoDefine.ProtoWireType.PWT_Varint_VALUE : {
						m_uint32_ = common.miniproto.ProtoTool.UInt32Decode(buf);
						set_has_m_uint32();
					}
					break;
					...
					break;
					case 6 << 3 | common.miniproto.ProtoDefine.ProtoWireType.PWT_Varint_VALUE : {
						m_sint64_ = common.miniproto.ProtoTool.SInt64Decode(buf);
						set_has_m_sint64();
					}
					break;
					case 7 << 3 | common.miniproto.ProtoDefine.ProtoWireType.PWT_Varint_VALUE : {
						m_uint64_ = common.miniproto.ProtoTool.UInt64Decode(buf);
						set_has_m_uint64();
					}
					break;

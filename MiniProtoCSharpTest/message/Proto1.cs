...
public class MsgTestSingular : common.miniproto.ProtoBase
{
	...
	public override ulong ByteSize()
	{
		...
		if (has_m_sint32())
		{
			bytes += common.miniproto.ProtoTool.KeyByteSize(3u, (uint)common.miniproto.ProtoWireType.PWT_Varint);
			bytes += common.miniproto.ProtoTool.SInt32ByteSize(m_sint32_);
		}
		if (has_m_uint32())
		{
			bytes += common.miniproto.ProtoTool.KeyByteSize(4u, (uint)common.miniproto.ProtoWireType.PWT_Varint);
		...
		if (has_m_sint64())
		{
			bytes += common.miniproto.ProtoTool.KeyByteSize(6u, (uint)common.miniproto.ProtoWireType.PWT_Varint);
			bytes += common.miniproto.ProtoTool.SInt64ByteSize(m_sint64_);
		}
		if (has_m_uint64())
		{
			bytes += common.miniproto.ProtoTool.KeyByteSize(7u, (uint)common.miniproto.ProtoWireType.PWT_Varint);
	...
	public override ulong Code(Stream buf, ulong size)
	{
		...
		if (has_m_sint32())
		{
			bytes += common.miniproto.ProtoTool.KeyCode(3u, (uint)common.miniproto.ProtoWireType.PWT_Varint, buf);
			bytes += common.miniproto.ProtoTool.SInt32Code(m_sint32_, buf);
		}
		if (has_m_uint32())
		{
			bytes += common.miniproto.ProtoTool.KeyCode(4u, (uint)common.miniproto.ProtoWireType.PWT_Varint, buf);
		...
		if (has_m_sint64())
		{
			bytes += common.miniproto.ProtoTool.KeyCode(6u, (uint)common.miniproto.ProtoWireType.PWT_Varint, buf);
			bytes += common.miniproto.ProtoTool.SInt64Code(m_sint64_, buf);
		}
		if (has_m_uint64())
		{
			bytes += common.miniproto.ProtoTool.KeyCode(7u, (uint)common.miniproto.ProtoWireType.PWT_Varint, buf);
	...
	public override ulong Decode(Stream buf, ulong size)
	{
		...
		while (bytes < size)
		{
			...
			switch (num << 3 | type)
			{
				...
				break;
				case 3 << 3 | (uint)common.miniproto.ProtoWireType.PWT_Varint:
				{
					bytes += common.miniproto.ProtoTool.SInt32Decode(ref m_sint32_, buf);
					set_has_m_sint32();
				}
				break;
				case 4 << 3 | (uint)common.miniproto.ProtoWireType.PWT_Varint:
				{
					bytes += common.miniproto.ProtoTool.UInt32Decode(ref m_uint32_, buf);
					set_has_m_uint32();
				}
				break;
				...
				break;
				case 6 << 3 | (uint)common.miniproto.ProtoWireType.PWT_Varint:
				{
					bytes += common.miniproto.ProtoTool.SInt64Decode(ref m_sint64_, buf);
					set_has_m_sint64();
				}
				break;
				case 7 << 3 | (uint)common.miniproto.ProtoWireType.PWT_Varint:
				{
					bytes += common.miniproto.ProtoTool.UInt64Decode(ref m_uint64_, buf);
					set_has_m_uint64();
				}
				break;

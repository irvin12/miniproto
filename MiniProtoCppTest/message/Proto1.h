...
template <template<typename> class A>
common::miniproto::byte_size MsgNull<A>::Code(common::miniproto::byte *buf, common::miniproto::byte_size size) const
{
	common::miniproto::byte_size bytes = 0;
...
template <template<typename> class A>
common::miniproto::byte_size MsgNull<A>::Decode(const common::miniproto::byte* buf, common::miniproto::byte_size size)
{
	common::miniproto::byte_size bytes = 0;
...
common::miniproto::byte_size MsgTestSingular<A>::ByteSize() const
{
	...
	if (has_m_sint32())
	{
		bytes += common::miniproto::ProtoTool::KeyByteSize(3, common::miniproto::ProtoWireType::PWT_Varint);
		bytes += common::miniproto::ProtoTool::SInt32ByteSize(m_sint32_);
	}
	if (has_m_uint32())
	{
		bytes += common::miniproto::ProtoTool::KeyByteSize(4, common::miniproto::ProtoWireType::PWT_Varint);
		bytes += common::miniproto::ProtoTool::UInt32ByteSize(m_uint32_);
	}
	if (has_m_int64())
	{
	...
	if (has_m_sint64())
	{
		bytes += common::miniproto::ProtoTool::KeyByteSize(6, common::miniproto::ProtoWireType::PWT_Varint);
		bytes += common::miniproto::ProtoTool::SInt64ByteSize(m_sint64_);
	}
	if (has_m_uint64())
	{
		bytes += common::miniproto::ProtoTool::KeyByteSize(7, common::miniproto::ProtoWireType::PWT_Varint);
		bytes += common::miniproto::ProtoTool::UInt64ByteSize(m_uint64_);
	}
	if (has_m_float())
	{
...
template <template<typename> class A>
common::miniproto::byte_size MsgTestSingular<A>::Code(common::miniproto::byte *buf, common::miniproto::byte_size size) const
{
	common::miniproto::byte_size bytes = 0;
	
	if (has_m_bool())
	{
		bytes += common::miniproto::ProtoTool::KeyCode(1, common::miniproto::ProtoWireType::PWT_Varint, buf + bytes);
		bytes += common::miniproto::ProtoTool::BoolCode(m_bool_, buf + bytes);
	}
	if (has_m_int32())
	{
		bytes += common::miniproto::ProtoTool::KeyCode(2, common::miniproto::ProtoWireType::PWT_Varint, buf + bytes);
		bytes += common::miniproto::ProtoTool::Int32Code(m_int32_, buf + bytes);
	}
	if (has_m_sint32())
	{
		bytes += common::miniproto::ProtoTool::KeyCode(3, common::miniproto::ProtoWireType::PWT_Varint, buf + bytes);
		bytes += common::miniproto::ProtoTool::SInt32Code(m_sint32_, buf + bytes);
	}
	if (has_m_uint32())
	{
		bytes += common::miniproto::ProtoTool::KeyCode(4, common::miniproto::ProtoWireType::PWT_Varint, buf + bytes);
		bytes += common::miniproto::ProtoTool::UInt32Code(m_uint32_, buf + bytes);
	}
	if (has_m_int64())
	{
		bytes += common::miniproto::ProtoTool::KeyCode(5, common::miniproto::ProtoWireType::PWT_Varint, buf + bytes);
		bytes += common::miniproto::ProtoTool::Int64Code(m_int64_, buf + bytes);
	}
	if (has_m_sint64())
	{
		bytes += common::miniproto::ProtoTool::KeyCode(6, common::miniproto::ProtoWireType::PWT_Varint, buf + bytes);
		bytes += common::miniproto::ProtoTool::SInt64Code(m_sint64_, buf + bytes);
	}
	if (has_m_uint64())
	{
		bytes += common::miniproto::ProtoTool::KeyCode(7, common::miniproto::ProtoWireType::PWT_Varint, buf + bytes);
		bytes += common::miniproto::ProtoTool::UInt64Code(m_uint64_, buf + bytes);
	}
	if (has_m_float())
	{
		bytes += common::miniproto::ProtoTool::KeyCode(8, common::miniproto::ProtoWireType::PWT_32bit, buf + bytes);
		bytes += common::miniproto::ProtoTool::FloatCode(m_float_, buf + bytes);
	}
	if (has_m_double())
	{
		bytes += common::miniproto::ProtoTool::KeyCode(9, common::miniproto::ProtoWireType::PWT_64bit, buf + bytes);
		bytes += common::miniproto::ProtoTool::DoubleCode(m_double_, buf + bytes);
	}
	if (has_m_enum())
	{
		bytes += common::miniproto::ProtoTool::KeyCode(10, common::miniproto::ProtoWireType::PWT_Varint, buf + bytes);
		bytes += common::miniproto::ProtoTool::EnumCode(m_enum_, buf + bytes);
	}
	if (has_m_string())
	{
		bytes += common::miniproto::ProtoTool::KeyCode(11, common::miniproto::ProtoWireType::PWT_LengthDelimited, buf + bytes);
		bytes += common::miniproto::ProtoTool::StringCode(m_string_, buf + bytes);
	}
	if (has_m_bytes())
	{
		bytes += common::miniproto::ProtoTool::KeyCode(12, common::miniproto::ProtoWireType::PWT_LengthDelimited, buf + bytes);
		bytes += common::miniproto::ProtoTool::StringCode(m_bytes_, buf + bytes);
	}
...
common::miniproto::byte_size MsgTestSingular<A>::Code(std::ostream& buf, common::miniproto::byte_size size) const
{
	...
	if (has_m_sint32())
	{
		bytes += common::miniproto::ProtoTool::KeyCode(3, common::miniproto::ProtoWireType::PWT_Varint, buf);
		bytes += common::miniproto::ProtoTool::SInt32Code(m_sint32_, buf);
	}
	if (has_m_uint32())
	{
		bytes += common::miniproto::ProtoTool::KeyCode(4, common::miniproto::ProtoWireType::PWT_Varint, buf);
		bytes += common::miniproto::ProtoTool::UInt32Code(m_uint32_, buf);
	}
	if (has_m_int64())
	{
	...
	if (has_m_sint64())
	{
		bytes += common::miniproto::ProtoTool::KeyCode(6, common::miniproto::ProtoWireType::PWT_Varint, buf);
		bytes += common::miniproto::ProtoTool::SInt64Code(m_sint64_, buf);
	}
	if (has_m_uint64())
	{
		bytes += common::miniproto::ProtoTool::KeyCode(7, common::miniproto::ProtoWireType::PWT_Varint, buf);
		bytes += common::miniproto::ProtoTool::UInt64Code(m_uint64_, buf);
	}
	if (has_m_float())
	{
...
template <template<typename> class A>
common::miniproto::byte_size MsgTestSingular<A>::Decode(const common::miniproto::byte* buf, common::miniproto::byte_size size)
{
	common::miniproto::byte_size bytes = 0;
	...
	while (bytes < size)
	{
		...
		switch (num << 3 | type)
		{
			...
			{
				bytes += common::miniproto::ProtoTool::BoolDecode(m_bool_, buf + bytes);
				set_has_m_bool();
			}
			break;
			case 2 << 3 | common::miniproto::ProtoWireType::PWT_Varint:
			{
				bytes += common::miniproto::ProtoTool::Int32Decode(m_int32_, buf + bytes);
				set_has_m_int32();
			}
			break;
			case 3 << 3 | common::miniproto::ProtoWireType::PWT_Varint:
			{
				bytes += common::miniproto::ProtoTool::SInt32Decode(m_sint32_, buf + bytes);
				set_has_m_sint32();
			}
			break;
			case 4 << 3 | common::miniproto::ProtoWireType::PWT_Varint:
			{
				bytes += common::miniproto::ProtoTool::UInt32Decode(m_uint32_, buf + bytes);
				set_has_m_uint32();
			}
			break;
			case 5 << 3 | common::miniproto::ProtoWireType::PWT_Varint:
			{
				bytes += common::miniproto::ProtoTool::Int64Decode(m_int64_, buf + bytes);
				set_has_m_int64();
			}
			break;
			case 6 << 3 | common::miniproto::ProtoWireType::PWT_Varint:
			{
				bytes += common::miniproto::ProtoTool::SInt64Decode(m_sint64_, buf + bytes);
				set_has_m_sint64();
			}
			break;
			case 7 << 3 | common::miniproto::ProtoWireType::PWT_Varint:
			{
				bytes += common::miniproto::ProtoTool::UInt64Decode(m_uint64_, buf + bytes);
				set_has_m_uint64();
			}
			break;
			case 8 << 3 | common::miniproto::ProtoWireType::PWT_32bit:
			{
				bytes += common::miniproto::ProtoTool::FloatDecode(m_float_, buf + bytes);
				set_has_m_float();
			}
			break;
			case 9 << 3 | common::miniproto::ProtoWireType::PWT_64bit:
			{
				bytes += common::miniproto::ProtoTool::DoubleDecode(m_double_, buf + bytes);
				set_has_m_double();
			}
			break;
			case 10 << 3 | common::miniproto::ProtoWireType::PWT_Varint:
			{
				bytes += common::miniproto::ProtoTool::EnumDecode(m_enum_, buf + bytes);
				set_has_m_enum();
			}
			break;
			case 11 << 3 | common::miniproto::ProtoWireType::PWT_LengthDelimited:
			{
				bytes += common::miniproto::ProtoTool::StringDecode(m_string_, buf + bytes);
				set_has_m_string();
			}
			break;
			case 12 << 3 | common::miniproto::ProtoWireType::PWT_LengthDelimited:
			{
				bytes += common::miniproto::ProtoTool::StringDecode(m_bytes_, buf + bytes);
				set_has_m_bytes();
			}
			break;
			default:
...
common::miniproto::byte_size MsgTestSingular<A>::Decode(std::istream& buf, common::miniproto::byte_size size)
{
	...
	while (bytes < size)
	{
		...
		switch (num << 3 | type)
		{
			...
			case 3 << 3 | common::miniproto::ProtoWireType::PWT_Varint:
			{
				bytes += common::miniproto::ProtoTool::SInt32Decode(m_sint32_, buf);
				set_has_m_sint32();
			}
			break;
			case 4 << 3 | common::miniproto::ProtoWireType::PWT_Varint:
			{
				bytes += common::miniproto::ProtoTool::UInt32Decode(m_uint32_, buf);
				set_has_m_uint32();
			}
			break;
			case 5 << 3 | common::miniproto::ProtoWireType::PWT_Varint:
			...
			case 6 << 3 | common::miniproto::ProtoWireType::PWT_Varint:
			{
				bytes += common::miniproto::ProtoTool::SInt64Decode(m_sint64_, buf);
				set_has_m_sint64();
			}
			break;
			case 7 << 3 | common::miniproto::ProtoWireType::PWT_Varint:
			{
				bytes += common::miniproto::ProtoTool::UInt64Decode(m_uint64_, buf);
				set_has_m_uint64();
			}
			break;
			case 8 << 3 | common::miniproto::ProtoWireType::PWT_32bit:

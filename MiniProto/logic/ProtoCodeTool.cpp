...
void ProtoCodeTool::ProtoMessage2Head_Declarations(const ProtoStruct& protoStruct, std::ofstream& of)
{
	...
	of << "\tvirtual common::miniproto::byte_size Code(common::miniproto::byte* buf, common::miniproto::byte_size size) const;\n";
	of << "\tvirtual common::miniproto::byte_size Decode(const common::miniproto::byte* buf, common::miniproto::byte_size size);\n";
...
{
	of << "template <template<typename> class A>\n";
	of << "common::miniproto::byte_size " << protoStruct.m_Name << "<A>::Code(common::miniproto::byte *buf, common::miniproto::byte_size size) const\n";
	of << "{\n";
	of << "\tcommon::miniproto::byte_size bytes = 0;\n";
	of << "\t\n";
	std::map<unsigned int, MessageMember>::const_iterator itMessageMember = protoStruct.m_MessageMembers.begin();
	while (itMessageMember != protoStruct.m_MessageMembers.end())
	{
		...
		case PMM_singular:
		{
			of << "\t\tbytes += common::miniproto::ProtoTool::KeyCode(" << messageMember.m_Tag << ", " << messageMember.CppValueWireType() << ", buf + bytes);\n";
			of << "\t\tbytes += common::miniproto::ProtoTool::" << messageMember.ValueFunPrefix() << "Code(" << messageMember.m_Name << "_, buf + bytes);\n";
		}
		break;
		case PMM_array:
		{
			...
			case PRV_Proto3:
			{
				of << "\t\tbytes += common::miniproto::ProtoTool::KeyCode(" << messageMember.m_Tag << ", " << messageMember.CppCollectionWireType() << ", buf + bytes);\n";
				of << "\t\tbytes += common::miniproto::ProtoTool::ArrayCode(" << messageMember.m_Name << "_, buf + bytes, " << messageMember.CppValueTypeObj() << ");\n";
			}
			break;
			case PRV_Proto2:
			{
				...
				else
				{
					...
					of << "\t\t{\n";
					of << "\t\t\tbytes += common::miniproto::ProtoTool::KeyCode(" << messageMember.m_Tag << ", " << messageMember.CppValueWireType() << ", buf + bytes); \n";
					of << "\t\t\tbytes += common::miniproto::ProtoTool::" << messageMember.ValueFunPrefix() << "Code(" << messageMember.m_Name << "_[i], buf + bytes);\n";
					of << "\t\t}\n";
				}
			}
			break;
		...
		case PMM_set:
		{
			...
			{
				of << "\t\tbytes += common::miniproto::ProtoTool::KeyCode(" << messageMember.m_Tag << ", " << messageMember.CppCollectionWireType() << ", buf + bytes);\n";
				of << "\t\tbytes += common::miniproto::ProtoTool::SetCode(" << messageMember.m_Name << "_, buf + bytes, " << messageMember.CppValueTypeObj() << ");\n";
			}
			break;
			case PRV_Proto2:
			{
				...
				else
				{
					...
					of << "\t\t{\n";
					of << "\t\t\tbytes += common::miniproto::ProtoTool::KeyCode(" << messageMember.m_Tag << ", " << messageMember.CppValueWireType() << ", buf + bytes); \n";
					of << "\t\t\tbytes += common::miniproto::ProtoTool::" << messageMember.ValueFunPrefix() << "Code(*_" << messageMember.m_Name << "_it, buf + bytes);\n";
					of << "\t\t\t_" << messageMember.m_Name << "_it++;\n";
					of << "\t\t}\n";
				}
			}
		...
		case PMM_map:
		{
			...
			{
				of << "\t\tbytes += common::miniproto::ProtoTool::KeyCode(" << messageMember.m_Tag << ", " << messageMember.CppCollectionWireType() << ", buf + bytes);\n";
				of << "\t\tbytes += common::miniproto::ProtoTool::MapCode(" << messageMember.m_Name << "_, buf + bytes, " << messageMember.CppKeyTypeObj() << ", " << messageMember.CppValueTypeObj() << ");\n";
			}
			break;
			case PRV_Proto2:
			{
				...
				else
				{
					...
					of << "\t\t{\n";
					of << "\t\t\tbytes += common::miniproto::ProtoTool::KeyCode(" << messageMember.m_Tag << ", " << messageMember.CppCollectionWireType() << ", buf + bytes); \n";
					of << "\t\t\tbytes += common::miniproto::ProtoTool::MapEntryCode(_" << messageMember.m_Name << "_it->first, _" << messageMember.m_Name << "_it->second, buf + bytes, " << messageMember.CppKeyTypeObj() << ", " << messageMember.CppValueTypeObj() << ");\n";
					of << "\t\t\t_" << messageMember.m_Name << "_it++;\n";
					of << "\t\t}\n";
				}
			}
...
{
	of << "template <template<typename> class A>\n";
	of << "common::miniproto::byte_size " << protoStruct.m_Name << "<A>::Decode(const common::miniproto::byte* buf, common::miniproto::byte_size size)\n";
	of << "{\n";
	of << "\tcommon::miniproto::byte_size bytes = 0;\n";
	of << "\t\n";
	...
	of << "\twhile (bytes < size)\n";
	of << "\t{\n";
	of << "\t\tbytes += common::miniproto::ProtoTool::KeyDecode(num, type, buf + bytes);\n";
	...
	while (itMessageMember != protoStruct.m_MessageMembers.end())
	{
		...
		case PMM_singular:
		{
			...
			of << "\t\t\t{\n";
			of << "\t\t\t\tbytes += common::miniproto::ProtoTool::" << messageMember.ValueFunPrefix() << "Decode(" << messageMember.m_Name << "_, buf + bytes);\n";
			of << "\t\t\t\tset_has_" << messageMember.m_Name << "();\n";
			of << "\t\t\t}\n";
			of << "\t\t\tbreak;\n";
		}
		...
		case PMM_array:
		{
			...
			case PRV_Proto3:
			{
				...
				of << "\t\t\t{\n";
				of << "\t\t\t\tbytes += common::miniproto::ProtoTool::ArrayDecode(" << messageMember.m_Name << "_, buf + bytes, " << messageMember.CppValueTypeObj() << ");\n";
				of << "\t\t\t\tset_has_" << messageMember.m_Name << "();\n";
				of << "\t\t\t}\n";
				of << "\t\t\tbreak;\n";
			}
			...
			case PRV_Proto2:
			{
				...
				else
				{
					...
					of << "\t\t\t\tbytes += common::miniproto::ProtoTool::ArrayEntryDecode(value, buf + bytes, " << messageMember.CppValueTypeObj() << ");\n";
		...
		case PMM_set:
		{
			...
			case PRV_Proto3:
			{
				of << "\t\t\tcase " << messageMember.m_Tag << " << 3 | " << messageMember.CppCollectionWireType() << ":\n";
				of << "\t\t\t{\n";
				of << "\t\t\t\tbytes += common::miniproto::ProtoTool::SetDecode(" << messageMember.m_Name << "_, buf + bytes, " << messageMember.CppValueTypeObj() << ");\n";
				of << "\t\t\t\tset_has_" << messageMember.m_Name << "();\n";
				of << "\t\t\t}\n";
				of << "\t\t\tbreak;\n";
			}
			...
			case PRV_Proto2:
			{
				...
				else
				{
					...
					of << "\t\t\t{\n";
					of << "\t\t\t\t" << messageMember.CppValueType() << " value;\n";
					of << "\t\t\t\tbytes += common::miniproto::ProtoTool::SetEntryDecode(value, buf + bytes, " << messageMember.CppValueTypeObj() << ");\n";
					of << "\t\t\t\tadd_" << messageMember.m_Name << "(std::move(value));\n";
					of << "\t\t\t}\n";
					of << "\t\t\tbreak;\n";
				}
		...
		case PMM_map:
		{
			...
			case PRV_Proto3:
			{
				of << "\t\t\tcase " << messageMember.m_Tag << " << 3 | " << messageMember.CppCollectionWireType() << ":\n";
				of << "\t\t\t{\n";
				of << "\t\t\t\tbytes += common::miniproto::ProtoTool::MapDecode(" << messageMember.m_Name << "_, buf + bytes, " << messageMember.CppKeyTypeObj() << ", " << messageMember.CppValueTypeObj() << ");\n";
				of << "\t\t\t\tset_has_" << messageMember.m_Name << "();\n";
				of << "\t\t\t}\n";
				of << "\t\t\tbreak;\n";
			}
			...
			case PRV_Proto2:
			{
				...
				else
				{
					...
					of << "\t\t\t\t" << messageMember.CppValueType() << " value;\n";
					of << "\t\t\t\tbytes += common::miniproto::ProtoTool::MapEntryDecode(key, value, buf + bytes, " << messageMember.CppKeyTypeObj() << ", " << messageMember.CppValueTypeObj() << ");\n";
	...
	of << "\t\t\tdefault:\n";
	of << "\t\t\tbytes += common::miniproto::ProtoTool::UnknownDecode(type, buf + bytes);\n";
	of << "\t\t\tbreak;\n";
	of << "\t\t}\n";
	of << "\t}\n";
	of << "\t\n";
...
void ProtoCodeTool::ProtoMessage2Head_MemberCleanerImplementations(const ProtoStruct& protoStruct, const MessageMember& messageMember, std::ofstream& of)
{
	...
	case PMM_singular:
	{
		...
		case PMT_string:
		{
			...
			of << "\t{\n";
			of << "\t\t" << messageMember.m_Name << "_.swap(" << messageMember.CppValueType() << "());\n";
			of << "\t}\n";
			of << "}\n";
		}
		break;
	...
	case PMM_array:
	{
		...
		of << "\tif (" << messageMember.m_Name << "_.capacity() > 0)\n";
		of << "\t{\n";
		of << "\t\t" << messageMember.m_Name << "_.swap(" << messageMember.CppArrayType() << "());\n";
		of << "\t}\n";
		of << "}\n";
	}
	break;
	case PMM_set:
	{
		...
		of << "\tif (" << messageMember.m_Name << "_.size() > 0)\n";
		of << "\t{\n";
		of << "\t\t" << messageMember.m_Name << "_.swap(" << messageMember.CppSetType() << "());\n";
		of << "\t}\n";
		of << "}\n";
	}
	break;
	case PMM_map:
	{
		...
		of << "\tif (" << messageMember.m_Name << "_.size() > 0)\n";
		of << "\t{\n";
		of << "\t\t" << messageMember.m_Name << "_.swap(" << messageMember.CppMapType() << "());\n";
		of << "\t}\n";
		of << "}\n";
	}
	break;
		...
		case PMM_array:
		{
			...
			case PRV_Proto3:
			{
				...
				case PMT_message:
				{
					...
					of << "\t\t\t{\n";
					of << "\t\t\t\tbytes += common.miniproto.ProtoTool.KeyByteSize(" << messageMember.m_Tag << "u, (uint)" << messageMember.CsCollectionWireType() << ");\n";
					of << "\t\t\t\tbytes += common.miniproto.ProtoTool.ArrayByteSize(" << messageMember.m_Name << "_);\n";
					of << "\t\t\t}\n";
				}
				break;
				default:
		...
		case PMM_map:
		{
			...
			case PRV_Proto3:
			{
				...
				case PMT_message:
				{
					...
					of << "\t\t\t{\n";
					of << "\t\t\t\tbytes += common.miniproto.ProtoTool.KeyByteSize(" << messageMember.m_Tag << "u, (uint)" << messageMember.CsCollectionWireType() << ");\n";
					of << "\t\t\t\tbytes += common.miniproto.ProtoTool.DictionaryByteSize(" << messageMember.m_Name << "_, " << messageMember.CsKeyTypeObj() << ");\n";
					of << "\t\t\t}\n";
				}
				break;
				default:
			...
			case PRV_Proto2:
			{
				...
				else
				{
					...
					case PMT_message:
					{
						...
						of << "\t\t\t\t{\n";
						of << "\t\t\t\t\tbytes += common.miniproto.ProtoTool.KeyByteSize(" << messageMember.m_Tag << "u, (uint)" << messageMember.CsCollectionWireType() << "); \n";
						of << "\t\t\t\t\tbytes += common.miniproto.ProtoTool.EntryByteSize(value.Key, value.Value, " << messageMember.CsKeyTypeObj() << ");\n";
						of << "\t\t\t\t}\n";
						of << "\t\t\t}\n";
					}
					break;
		...
		case PMM_array:
		{
			...
			case PRV_Proto3:
			{
				...
				case PMT_message:
				{
					...
					of << "\t\t\t{\n";
					of << "\t\t\t\tbytes += common.miniproto.ProtoTool.KeyCode(" << messageMember.m_Tag << "u, (uint)" << messageMember.CsCollectionWireType() << ", buf);\n";
					of << "\t\t\t\tbytes += common.miniproto.ProtoTool.ArrayCode(" << messageMember.m_Name << "_, buf);\n";
					of << "\t\t\t}\n";
				}
				break;
				default:
		...
		case PMM_map:
		{
			...
			case PRV_Proto3:
			{
				...
				case PMT_message:
				{
					...
					of << "\t\t\t{\n";
					of << "\t\t\t\tbytes += common.miniproto.ProtoTool.KeyCode(" << messageMember.m_Tag << "u, (uint)" << messageMember.CsCollectionWireType() << ", buf);\n";
					of << "\t\t\t\tbytes += common.miniproto.ProtoTool.DictionaryCode(" << messageMember.m_Name << "_, buf, " << messageMember.CsKeyTypeObj() << ");\n";
					of << "\t\t\t}\n";
				}
				break;
				default:
			...
			case PRV_Proto2:
			{
				...
				else
				{
					...
					case PMT_message:
					{
						...
						of << "\t\t\t\t{\n";
						of << "\t\t\t\t\tbytes += common.miniproto.ProtoTool.KeyCode(" << messageMember.m_Tag << "u, (uint)" << messageMember.CsCollectionWireType() << ", buf); \n";
						of << "\t\t\t\t\tbytes += common.miniproto.ProtoTool.EntryCode(value.Key, value.Value, buf, " << messageMember.CsKeyTypeObj() << ");\n";
						of << "\t\t\t\t}\n";
						of << "\t\t\t}\n";
					}
					break;
		...
		case PMM_array:
		{
			...
			case PRV_Proto3:
			{
				...
				case PMT_message:
				{
					...
					of << "\t\t\t\t\tif (null != " << messageMember.m_Name << "_)\n";
					of << "\t\t\t\t\t{\n";
					of << "\t\t\t\t\t\tbytes += common.miniproto.ProtoTool.ArrayDecode(" << messageMember.m_Name << "_, buf);\n";
					of << "\t\t\t\t\t\tset_has_" << messageMember.m_Name << "();\n";
					of << "\t\t\t\t\t}\n";
					of << "\t\t\t\t\telse\n";
					of << "\t\t\t\t\t{\n";
		...
		case PMM_map:
		{
			...
			case PRV_Proto3:
			{
				...
				case PMT_message:
				{
					...
					of << "\t\t\t\t\tif (null != " << messageMember.m_Name << "_)\n";
					of << "\t\t\t\t\t{\n";
					of << "\t\t\t\t\t\tbytes += common.miniproto.ProtoTool.DictionaryDecode(" << messageMember.m_Name << "_, buf, " << messageMember.CsKeyTypeObj() << ");\n";
					of << "\t\t\t\t\t\tset_has_" << messageMember.m_Name << "();\n";
					of << "\t\t\t\t\t}\n";
					of << "\t\t\t\t\telse\n";
					of << "\t\t\t\t\t{\n";
...
void ProtoCodeTool::ProtoMessage2Java_Decode(const ProtoStruct& protoStruct, std::ofstream& of)
{
	...
	while (itMessageMember != protoStruct.m_MessageMembers.end())
	{
		...
		case PMM_singular:
		{
			...
			{
				of << "\t\t\t\t\tcase " << messageMember.m_Tag << " << 3 | " << messageMember.JavaValueWireType() << "_VALUE : {\n";
				of << "\t\t\t\t\t\t" << messageMember.m_Name << "_ = common.miniproto.ProtoTool." << messageMember.ValueFunPrefix() << "Decode(buf, " << messageMember.JavaValueType() << ".class);\n";
				of << "\t\t\t\t\t\tset_has_" << messageMember.m_Name << "();\n";
				of << "\t\t\t\t\t}\n";
				of << "\t\t\t\t\tbreak;\n";
			}
		...
		case PMM_array:
		{
			...
			case PRV_Proto3:
			{
				...
				case PMT_message:
				{
					...
					of << "\t\t\t\t\t\t}\n";
					of << "\t\t\t\t\t\tif (null != " << messageMember.m_Name << "_) {\n";
					of << "\t\t\t\t\t\t\tcommon.miniproto.ProtoTool.ArrayDecode(" << messageMember.m_Name << "_, buf, " << messageMember.JavaValueFieldType() << ", " << messageMember.JavaValueType() << ".class);\n";
					of << "\t\t\t\t\t\t\tset_has_" << messageMember.m_Name << "();\n";
					of << "\t\t\t\t\t\t} else {\n";
					of << "\t\t\t\t\t\t\tcommon.miniproto.ProtoTool.UnknownDecode(type, buf);\n";
					of << "\t\t\t\t\t\t}\n";
			...
			case PRV_Proto2:
			{
				...
				else
				{
					...
					{
						of << "\t\t\t\t\tcase " << messageMember.m_Tag << " << 3 | " << messageMember.JavaValueWireType() << "_VALUE : {\n";
						of << "\t\t\t\t\t\t" << messageMember.JavaValueType() << " value = common.miniproto.ProtoTool." << messageMember.ValueFunPrefix() << "Decode(buf, " << messageMember.JavaValueType() << ".class);\n";
						of << "\t\t\t\t\t\tadd_" << messageMember.m_Name << "(value);\n";
						of << "\t\t\t\t\t}\n";
						of << "\t\t\t\t\tbreak;\n";
					}
		...
		case PMM_map:
		{
			...
			case PRV_Proto3:
			{
				...
				case PMT_message:
				{
					...
					of << "\t\t\t\t\t\t}\n";
					of << "\t\t\t\t\t\tif (null != " << messageMember.m_Name << "_) {\n";
					of << "\t\t\t\t\t\t\tcommon.miniproto.ProtoTool.MapDecode(" << messageMember.m_Name << "_, buf, " << messageMember.JavaKeyFieldType() << ", " << messageMember.JavaValueFieldType() << ", " << messageMember.JavaValueType() << ".class);\n";
					of << "\t\t\t\t\t\t\tset_has_" << messageMember.m_Name << "();\n";
					of << "\t\t\t\t\t\t} else {\n";
					of << "\t\t\t\t\t\t\tcommon.miniproto.ProtoTool.UnknownDecode(type, buf);\n";
					of << "\t\t\t\t\t\t}\n";
			...
			case PRV_Proto2:
			{
				...
				else
				{
					...
					case PMT_message:
					{
						...
						of << "\t\t\t\t\t\t}\n";
						of << "\t\t\t\t\t\tif (null != " << messageMember.m_Name << "_) {\n";
						of << "\t\t\t\t\t\t\tcommon.miniproto.ProtoTool.EntryDecode(" << messageMember.m_Name << "_, buf, " << messageMember.JavaKeyFieldType() << ", " << messageMember.JavaValueFieldType() << ", " << messageMember.JavaValueType() << ".class);\n";
						of << "\t\t\t\t\t\t\tset_has_" << messageMember.m_Name << "();\n";
						of << "\t\t\t\t\t\t} else {\n";
						of << "\t\t\t\t\t\t\tcommon.miniproto.ProtoTool.UnknownDecode(type, buf);\n";
						of << "\t\t\t\t\t\t}\n";
